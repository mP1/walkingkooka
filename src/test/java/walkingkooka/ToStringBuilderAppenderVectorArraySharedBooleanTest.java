...
public class ToStringBuilderAppenderVectorArraySharedBooleanTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorArraySharedBoolean, boolean[]> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorArraySharedBoolean> type() {
        return ToStringBuilderAppenderVectorArraySharedBoolean.class;
    }
}
