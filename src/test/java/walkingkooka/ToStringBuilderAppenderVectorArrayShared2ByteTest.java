...
public final class ToStringBuilderAppenderVectorArrayShared2ByteTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorArrayShared2Byte, byte[]> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorArrayShared2Byte> type() {
        return ToStringBuilderAppenderVectorArrayShared2Byte.class;
    }
}
