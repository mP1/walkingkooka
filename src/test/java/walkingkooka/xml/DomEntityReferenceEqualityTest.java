...
public final class DomEntityReferenceEqualityTest extends DomParentNodeEqualityTestCase<DomEntityReference> {
    
    @Test
    public void testDifferentName() {
        this.checkNotEquals(new DomEntityReference(document().createEntityReference("different")));
    }
