...
public final class LimitPushableStreamStreamIntermediatePushableStreamConsumerTest extends
        LimitOrSkipPushableStreamStreamIntermediatePushableStreamConsumerTestCase<LimitPushableStreamStreamIntermediatePushableStreamConsumer<String>> {
    ...
    @Override
    public Class<LimitPushableStreamStreamIntermediatePushableStreamConsumer<String>> type() {
        return Cast.to(LimitPushableStreamStreamIntermediatePushableStreamConsumer.class);
    }
}
