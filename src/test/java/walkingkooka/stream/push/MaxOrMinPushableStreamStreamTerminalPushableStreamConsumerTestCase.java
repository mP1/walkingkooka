...
public abstract class MaxOrMinPushableStreamStreamTerminalPushableStreamConsumerTestCase<C extends MaxOrMinPushableStreamStreamTerminalPushableStreamConsumer<String>> extends PushableStreamStreamTerminalPushableStreamConsumerTestCase<C, Optional<String>> {

    MaxOrMinPushableStreamStreamTerminalPushableStreamConsumerTestCase() {
        super();
    }
    ...
    abstract C createPushableStreamStreamPushableStreamConsumer(final Comparator<String> comparator, final CloseableCollection closeables);
}
