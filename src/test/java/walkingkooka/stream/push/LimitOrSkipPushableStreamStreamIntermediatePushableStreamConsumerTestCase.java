...
public abstract class LimitOrSkipPushableStreamStreamIntermediatePushableStreamConsumerTestCase<P extends LimitOrSkipPushableStreamStreamIntermediatePushableStreamConsumer<String>>
        extends PushableStreamStreamIntermediatePushableStreamConsumerTestCase<P> {

    LimitOrSkipPushableStreamStreamIntermediatePushableStreamConsumerTestCase() {
        super();
    }
