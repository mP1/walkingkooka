...
public final class ToStringBuilderAppenderVectorArrayShared2DoubleTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorArrayShared2Double, double[]> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorArrayShared2Double> type() {
        return ToStringBuilderAppenderVectorArrayShared2Double.class;
    }
}
