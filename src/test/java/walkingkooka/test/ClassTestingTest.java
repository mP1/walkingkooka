...
public final class ClassTestingTest {
    ...
    public void testWithoutMathContextParameter() {
        new TestWithoutMathContextParameter().publicMethodParametersTypesCheck(Sets.of(Void.class, MathContext.class));
    }
    ...
    public void testWithMathContextParameter() {
        ...
        try {
            new TestWithMathContextParameter().publicMethodParametersTypesCheck(Sets.of(Void.class, MathContext.class));
