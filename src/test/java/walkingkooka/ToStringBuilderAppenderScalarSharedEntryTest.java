...
public final class ToStringBuilderAppenderScalarSharedEntryTest extends ToStringBuilderAppenderScalarTestCase<ToStringBuilderAppenderScalarSharedEntry, Entry<?, ?>> {
    ...
    @Override
    public Class<ToStringBuilderAppenderScalarSharedEntry> type() {
        return ToStringBuilderAppenderScalarSharedEntry.class;
    }
}
