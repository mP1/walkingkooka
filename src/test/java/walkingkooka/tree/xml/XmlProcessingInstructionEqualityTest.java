...
public final class XmlProcessingInstructionEqualityTest extends XmlLeafNodeEqualityTestCase<XmlProcessingInstruction> {
    ...
    final XmlProcessingInstruction createNode(final DocumentBuilder builder) {
