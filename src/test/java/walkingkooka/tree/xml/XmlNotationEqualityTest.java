...
public final class XmlNotationEqualityTest extends XmlLeafNodeEqualityTestCase<XmlNotation> {
    ...
    @Override final XmlNotation createNode(final DocumentBuilder builder) {
