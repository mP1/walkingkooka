...
public final class XmlElementEqualityTest extends XmlParentNodeEqualityTestCase<XmlElement> {
    ...
    XmlElement createNode(final Document document) {
        return XmlElement.with(document.createElement(TAG));
    }

    private XmlElement createNode(final Element element) {
        return XmlElement.with(element);
    }
}
