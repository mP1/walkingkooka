...
public final class XmlEntityEqualityTest extends XmlParentNodeEqualityTestCase<XmlEntity> {
    ...
    @Override final XmlEntity createNode(final DocumentBuilder builder) {
