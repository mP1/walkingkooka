...
public final class ExpressionNodeSelectorStartsWithFunctionTest extends ExpressionNodeSelectorFunctionTestCase<ExpressionNodeSelectorStartsWithFunction, Boolean> {
    ...
    @Override
    protected ExpressionNodeSelectorStartsWithFunction createBiFunction() {
        return ExpressionNodeSelectorStartsWithFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorStartsWithFunction> type() {
        return ExpressionNodeSelectorStartsWithFunction.class;
    }
}
