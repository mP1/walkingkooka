...
public final class ExpressionNodeSelectorPredicateEndsWithFunctionTest extends ExpressionNodeSelectorPredicateFunctionTestCase<ExpressionNodeSelectorPredicateEndsWithFunction, Boolean> {
    ...
    @Override
    protected ExpressionNodeSelectorPredicateEndsWithFunction createBiFunction() {
        return ExpressionNodeSelectorPredicateEndsWithFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorPredicateEndsWithFunction> type() {
        return ExpressionNodeSelectorPredicateEndsWithFunction.class;
    }
}
