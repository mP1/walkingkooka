...
public final class ExpressionNodeSelectorPredicateSubstringFunctionTest extends ExpressionNodeSelectorPredicateFunctionTestCase<ExpressionNodeSelectorPredicateSubstringFunction, String> {
    ...
    @Override
    protected ExpressionNodeSelectorPredicateSubstringFunction createBiFunction() {
        return ExpressionNodeSelectorPredicateSubstringFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorPredicateSubstringFunction> type() {
        return ExpressionNodeSelectorPredicateSubstringFunction.class;
    }
}
