...
public final class ExpressionNodeSelectorSubstringBeforeFunctionTest extends ExpressionNodeSelectorFunctionTestCase<ExpressionNodeSelectorSubstringBeforeFunction, String> {
    ...
    @Override
    protected ExpressionNodeSelectorSubstringBeforeFunction createBiFunction() {
        return ExpressionNodeSelectorSubstringBeforeFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorSubstringBeforeFunction> type() {
        return ExpressionNodeSelectorSubstringBeforeFunction.class;
    }
}
