...
public final class NodeSelectorPredicateNormalizeSpaceFunctionTest extends NodeSelectorPredicateFunctionTestCase<NodeSelectorPredicateNormalizeSpaceFunction, String> {
    ...
    @Override
    protected NodeSelectorPredicateNormalizeSpaceFunction createBiFunction() {
        return NodeSelectorPredicateNormalizeSpaceFunction.INSTANCE;
    }

    @Override
    protected Class<NodeSelectorPredicateNormalizeSpaceFunction> type() {
        return NodeSelectorPredicateNormalizeSpaceFunction.class;
    }
}
