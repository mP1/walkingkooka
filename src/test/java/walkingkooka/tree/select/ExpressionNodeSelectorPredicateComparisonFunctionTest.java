...
public final class ExpressionNodeSelectorPredicateComparisonFunctionTest extends ExpressionNodeSelectorPredicateFunctionTestCase<ExpressionNodeSelectorPredicateComparisonFunction, Boolean> {
    ...
    final void applyAndCheck3(final ComparisonRelation relation,
        ...
        this.applyAndCheck2(ExpressionNodeSelectorPredicateComparisonFunction.with(relation), parameters(first, second), result);
    }
    ...
    @Override
    protected ExpressionNodeSelectorPredicateComparisonFunction createBiFunction() {
        return ExpressionNodeSelectorPredicateComparisonFunction.with(ComparisonRelation.EQ);
    }

    @Override
    protected Class<ExpressionNodeSelectorPredicateComparisonFunction> type() {
        return ExpressionNodeSelectorPredicateComparisonFunction.class;
    }
}
