...
public abstract class ExpressionNodeSelectorPredicateFunctionTestCase<F extends ExpressionNodeSelectorPredicateFunction<V>, V> extends BiFunctionTestCase<F, List<Object>, ExpressionEvaluationContext, V> {
    ...
    final ExpressionEvaluationContext createContext() {
        return new FakeExpressionEvaluationContext() {
            ...
            public <T> T convert(final Object value, final Class<T> target) {
                return ExpressionNodeSelectorPredicateFunctionTestCase.this.convert(value, target);
            }
        };
    }
