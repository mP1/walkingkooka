...
public final class ExpressionNodeSelectorComparisonFunctionTest extends ExpressionNodeSelectorFunctionTestCase<ExpressionNodeSelectorComparisonFunction, Boolean> {
    ...
    final void applyAndCheck3(final ComparisonRelation relation,
        ...
        this.applyAndCheck2(ExpressionNodeSelectorComparisonFunction.with(relation), parameters(first, second), result);
    }
    ...
    @Override
    protected ExpressionNodeSelectorComparisonFunction createBiFunction() {
        return ExpressionNodeSelectorComparisonFunction.with(ComparisonRelation.EQ);
    }

    @Override
    protected Class<ExpressionNodeSelectorComparisonFunction> type() {
        return ExpressionNodeSelectorComparisonFunction.class;
    }
}
