...
public final class ExpressionNodeSelectorNormalizeSpaceFunctionTest extends ExpressionNodeSelectorFunctionTestCase<ExpressionNodeSelectorNormalizeSpaceFunction, String> {
    ...
    @Override
    protected ExpressionNodeSelectorNormalizeSpaceFunction createBiFunction() {
        return ExpressionNodeSelectorNormalizeSpaceFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorNormalizeSpaceFunction> type() {
        return ExpressionNodeSelectorNormalizeSpaceFunction.class;
    }
}
