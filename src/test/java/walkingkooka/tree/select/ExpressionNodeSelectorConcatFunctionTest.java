...
public final class ExpressionNodeSelectorConcatFunctionTest extends ExpressionNodeSelectorFunctionTestCase<ExpressionNodeSelectorConcatFunction, String> {
    ...
    @Override
    protected ExpressionNodeSelectorConcatFunction createBiFunction() {
        return ExpressionNodeSelectorConcatFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorConcatFunction> type() {
        return ExpressionNodeSelectorConcatFunction.class;
    }
}
