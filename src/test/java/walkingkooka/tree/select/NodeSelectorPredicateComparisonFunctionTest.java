...
public final class NodeSelectorPredicateComparisonFunctionTest extends NodeSelectorPredicateFunctionTestCase<NodeSelectorPredicateComparisonFunction, Boolean> {
    ...
    @Override
    protected NodeSelectorPredicateComparisonFunction createBiFunction() {
        return NodeSelectorPredicateComparisonFunction.with(ComparisonRelation.EQ);
    }

    @Override
    protected Class<NodeSelectorPredicateComparisonFunction> type() {
        return NodeSelectorPredicateComparisonFunction.class;
    }
}
