...
public final class ExpressionNodeSelectorPredicateStartsWithFunctionTest extends ExpressionNodeSelectorPredicateFunctionTestCase<ExpressionNodeSelectorPredicateStartsWithFunction, Boolean> {
    ...
    @Override
    protected ExpressionNodeSelectorPredicateStartsWithFunction createBiFunction() {
        return ExpressionNodeSelectorPredicateStartsWithFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorPredicateStartsWithFunction> type() {
        return ExpressionNodeSelectorPredicateStartsWithFunction.class;
    }
}
