...
public final class ExpressionNodeSelectorSubstringFunctionTest extends ExpressionNodeSelectorFunctionTestCase<ExpressionNodeSelectorSubstringFunction, String> {
    ...
    @Override
    protected ExpressionNodeSelectorSubstringFunction createBiFunction() {
        return ExpressionNodeSelectorSubstringFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorSubstringFunction> type() {
        return ExpressionNodeSelectorSubstringFunction.class;
    }
}
