...
public final class ExpressionNodeSelectorEndsWithFunctionTest extends ExpressionNodeSelectorFunctionTestCase<ExpressionNodeSelectorEndsWithFunction, Boolean> {
    ...
    @Override
    protected ExpressionNodeSelectorEndsWithFunction createBiFunction() {
        return ExpressionNodeSelectorEndsWithFunction.INSTANCE;
    }

    @Override
    protected Class<ExpressionNodeSelectorEndsWithFunction> type() {
        return ExpressionNodeSelectorEndsWithFunction.class;
    }
}
