...
public final class ExpressionAndNodeTest extends ExpressionLogicalBinaryNodeTestCase<ExpressionAndNode> {
    ...
    public void testAccept() {
        ...
        final ExpressionAndNode and = this.createExpressionNode();
        final ExpressionNode text1 = and.children().get(0);
        final ExpressionNode text2 = and.children().get(1);
        ...
        new FakeExpressionNodeVisitor() {
            ...
            @Override
            protected Visiting startVisit(final ExpressionAndNode t) {
                assertSame(and, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final ExpressionAndNode t) {
                assertSame(and, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    ExpressionAndNode createExpressionNode(final ExpressionNode left, final ExpressionNode right) {
    ...
    @Override
    Class<ExpressionAndNode> expressionNodeType() {
        return ExpressionAndNode.class;
    }

    // JsonNodeMappingTesting...............................................................................................

    @Override
    public ExpressionAndNode fromJsonNode(final JsonNode from,
                                          final FromJsonNodeContext context) {
        return ExpressionAndNode.fromJsonNode(from, context);
    }
}
