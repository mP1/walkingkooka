...
public final class ExpressionLocalDateTimeNodeTest extends ExpressionLeafNodeTestCase<ExpressionLocalDateTimeNode, LocalDateTime> {
    ...
    public void testToLocalTime() {
        this.evaluateAndCheckLocalTime(this.createExpressionNode(),
                Converters.localDateTimeLocalTime().convert(this.value(), LocalTime.class, ConverterContexts.fake()));
    }
    ...
    @Override
    public ExpressionLocalDateTimeNode fromJsonNode(final JsonNode from,
                                                    final FromJsonNodeContext context) {
        return ExpressionLocalDateTimeNode.fromJsonNode(from, context);
    }
}
