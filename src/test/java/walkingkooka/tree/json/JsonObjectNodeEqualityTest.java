...
public final class JsonObjectNodeEqualityTest extends JsonParentNodeEqualityTestCase<JsonObjectNode> {
    ...
    public void testDifferentParent() {
        this.checkNotEquals(JsonNode.object().appendChild(this.createObject()));
    }

    @Override
    protected JsonNode createObject() {
