...
public final class BasicMapperTypedLocalDateTimeTest extends BasicMapperTypedTestCase2<BasicMapperTypedLocalDateTime, LocalDateTime> {
    ...
    @Override
    BasicMapperTypedLocalDateTime mapper() {
        return BasicMapperTypedLocalDateTime.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedLocalDateTime> type() {
        return BasicMapperTypedLocalDateTime.class;
    }
}
