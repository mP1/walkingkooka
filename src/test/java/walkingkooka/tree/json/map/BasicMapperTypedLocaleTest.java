...
public final class BasicMapperTypedLocaleTest extends BasicMapperTypedTestCase<BasicMapperTypedLocale, Locale> {
    ...
    @Override
    BasicMapperTypedLocale mapper() {
        return BasicMapperTypedLocale.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedLocale> type() {
        return BasicMapperTypedLocale.class;
    }
}
