...
public final class BasicMapperTypedLocalDateTest extends BasicMapperTypedTestCase2<BasicMapperTypedLocalDate, LocalDate> {
    ...
    @Override
    BasicMapperTypedLocalDate mapper() {
        return BasicMapperTypedLocalDate.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedLocalDate> type() {
        return BasicMapperTypedLocalDate.class;
    }
}
