...
public abstract class BasicMapperTypedNumberTestCase<M extends BasicMapperTypedNumber<T>, T extends Number> extends BasicMapperTypedTestCase<M, T>
        implements ToStringTesting<M> {

    BasicMapperTypedNumberTestCase() {
        super();
    }
