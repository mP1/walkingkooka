...
public final class BasicMapperTypedMapTest extends BasicMapperTypedTestCase<BasicMapperTypedMap, Map<?, ?>> {
    ...
    @Override
    BasicMapperTypedMap mapper() {
        return BasicMapperTypedMap.instance();
    }
    ...
    private JsonNode entry(final JsonNode key, final JsonNode value) {
        return JsonNode.object()
                .set(BasicMapperTypedMap.ENTRY_KEY, key)
    ...
    @Override
    public Class<BasicMapperTypedMap> type() {
        return BasicMapperTypedMap.class;
    }
}
