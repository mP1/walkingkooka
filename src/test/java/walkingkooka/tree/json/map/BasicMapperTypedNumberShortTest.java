...
public final class BasicMapperTypedNumberShortTest extends BasicMapperTypedNumberTestCase<BasicMapperTypedNumberShort, Short> {
    ...
    @Override
    BasicMapperTypedNumberShort mapper() {
        return BasicMapperTypedNumberShort.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedNumberShort> type() {
        return BasicMapperTypedNumberShort.class;
    }
}
