...
public final class BasicMapperTypedOptionalTest extends BasicMapperTypedTestCase<BasicMapperTypedOptional, Optional<?>> {
    ...
    private void roundtripAndCheck(final Optional<?> value) {
        final BasicMapperTypedOptional mapper = this.mapper();
        final JsonNode json = mapper.toJsonNode(value, this.toJsonNodeContext());
        final Optional<?> from = mapper.fromJsonNode(json, this.fromJsonNodeContext());
    ...
    @Override
    BasicMapperTypedOptional mapper() {
        return BasicMapperTypedOptional.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedOptional> type() {
        return BasicMapperTypedOptional.class;
    }
}
