...
public final class BasicMapperTypedNumberIntegerTest extends BasicMapperTypedNumberTestCase<BasicMapperTypedNumberInteger, Integer> {
    ...
    @Override
    BasicMapperTypedNumberInteger mapper() {
        return BasicMapperTypedNumberInteger.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedNumberInteger> type() {
        return BasicMapperTypedNumberInteger.class;
    }
}
