...
public final class BasicMapperTypedNumberByteTest extends BasicMapperTypedNumberTestCase<BasicMapperTypedNumberByte, Byte> {
    ...
    @Override
    BasicMapperTypedNumberByte mapper() {
        return BasicMapperTypedNumberByte.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedNumberByte> type() {
        return BasicMapperTypedNumberByte.class;
    }
}
