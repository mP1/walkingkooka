...
public final class BasicMapperTypedMathContextTest extends BasicMapperTypedTestCase<BasicMapperTypedMathContext, MathContext> {
    ...
    @Override
    BasicMapperTypedMathContext mapper() {
        return BasicMapperTypedMathContext.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedMathContext> type() {
        return BasicMapperTypedMathContext.class;
    }
}
