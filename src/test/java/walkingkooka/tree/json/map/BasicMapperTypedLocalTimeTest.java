...
public final class BasicMapperTypedLocalTimeTest extends BasicMapperTypedTestCase2<BasicMapperTypedLocalTime, LocalTime> {
    ...
    @Override
    BasicMapperTypedLocalTime mapper() {
        return BasicMapperTypedLocalTime.instance();
    }
    ...
    @Override
    public Class<BasicMapperTypedLocalTime> type() {
        return BasicMapperTypedLocalTime.class;
    }
}
