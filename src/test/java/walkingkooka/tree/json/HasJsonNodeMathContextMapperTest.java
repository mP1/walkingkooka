...
public final class HasJsonNodeMathContextMapperTest extends HasJsonNodeTypedMapperTestCase<HasJsonNodeMathContextMapper, MathContext> {
    ...
    @Override
    HasJsonNodeMathContextMapper mapper() {
        return HasJsonNodeMathContextMapper.instance();
    }
    ...
    @Override
    Class<MathContext> mapperType() {
        return MathContext.class;
    }

    @Override
    public Class<HasJsonNodeMathContextMapper> type() {
        return HasJsonNodeMathContextMapper.class;
    }
}
