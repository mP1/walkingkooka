...
public final class HasJsonNodeRoundingModeMapperTest extends HasJsonNodeTypedMapperTestCase<HasJsonNodeRoundingModeMapper, RoundingMode> {
    ...
    @Override
    HasJsonNodeRoundingModeMapper mapper() {
        return HasJsonNodeRoundingModeMapper.instance();
    }
    ...
    @Override
    public Class<HasJsonNodeRoundingModeMapper> type() {
        return HasJsonNodeRoundingModeMapper.class;
    }
}
