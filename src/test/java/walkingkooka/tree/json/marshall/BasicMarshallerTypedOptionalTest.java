...
public final class BasicMarshallerTypedOptionalTest extends BasicMarshallerTypedTestCase<BasicMarshallerTypedOptional, Optional<?>> {
    ...
    private void roundtripAndCheck(final Optional<?> value) {
        final BasicMarshallerTypedOptional marshaller = this.marshaller();
    ...
    @Override
    BasicMarshallerTypedOptional marshaller() {
        return BasicMarshallerTypedOptional.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedOptional> type() {
        return BasicMarshallerTypedOptional.class;
    }
}
