...
public final class BasicMarshallerTypedNumberShortTest extends BasicMarshallerTypedNumberTestCase<BasicMarshallerTypedNumberShort, Short> {
    ...
    @Override
    BasicMarshallerTypedNumberShort marshaller() {
        return BasicMarshallerTypedNumberShort.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedNumberShort> type() {
        return BasicMarshallerTypedNumberShort.class;
    }
}
