...
public final class BasicMarshallerTypedLocaleTest extends BasicMarshallerTypedTestCase<BasicMarshallerTypedLocale, Locale> {
    ...
    @Override
    BasicMarshallerTypedLocale marshaller() {
        return BasicMarshallerTypedLocale.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedLocale> type() {
        return BasicMarshallerTypedLocale.class;
    }
}
