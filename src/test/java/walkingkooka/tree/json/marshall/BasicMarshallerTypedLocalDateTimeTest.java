...
public final class BasicMarshallerTypedLocalDateTimeTest extends BasicMarshallerTypedTestCase2<BasicMarshallerTypedLocalDateTime, LocalDateTime> {
    ...
    @Override
    BasicMarshallerTypedLocalDateTime marshaller() {
        return BasicMarshallerTypedLocalDateTime.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedLocalDateTime> type() {
        return BasicMarshallerTypedLocalDateTime.class;
    }
}
