...
public final class BasicMarshallerTypedNumberLongTest extends BasicMarshallerTypedTestCase<BasicMarshallerTypedNumberLong, Long> {
    ...
    @Override
    BasicMarshallerTypedNumberLong marshaller() {
        return BasicMarshallerTypedNumberLong.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedNumberLong> type() {
        return BasicMarshallerTypedNumberLong.class;
    }
}
