...
public final class BasicMarshallerTypedCollectionListTest extends BasicMarshallerTypedTestCase<BasicMarshallerTypedCollectionList, List<?>> {
    ...
    @Override
    BasicMarshallerTypedCollectionList marshaller() {
        return BasicMarshallerTypedCollectionList.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedCollectionList> type() {
        return BasicMarshallerTypedCollectionList.class;
    }
}
