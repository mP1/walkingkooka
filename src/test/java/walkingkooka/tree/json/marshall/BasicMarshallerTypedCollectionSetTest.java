...
public final class BasicMarshallerTypedCollectionSetTest extends BasicMarshallerTypedTestCase<BasicMarshallerTypedCollectionSet, Set<?>> {
    ...
    @Override
    BasicMarshallerTypedCollectionSet marshaller() {
        return BasicMarshallerTypedCollectionSet.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedCollectionSet> type() {
        return BasicMarshallerTypedCollectionSet.class;
    }
}
