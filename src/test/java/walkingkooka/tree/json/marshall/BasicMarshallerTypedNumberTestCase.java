...
public abstract class BasicMarshallerTypedNumberTestCase<M extends BasicMarshallerTypedNumber<T>, T extends Number> extends BasicMarshallerTypedTestCase<M, T>
        implements ToStringTesting<M> {

    BasicMarshallerTypedNumberTestCase() {
        super();
    }
