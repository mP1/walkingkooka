...
public final class BasicMarshallerTypedNumberIntegerTest extends BasicMarshallerTypedNumberTestCase<BasicMarshallerTypedNumberInteger, Integer> {
    ...
    @Override
    BasicMarshallerTypedNumberInteger marshaller() {
        return BasicMarshallerTypedNumberInteger.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedNumberInteger> type() {
        return BasicMarshallerTypedNumberInteger.class;
    }
}
