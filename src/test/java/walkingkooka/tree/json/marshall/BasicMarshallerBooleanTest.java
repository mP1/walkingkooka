...
public final class BasicMarshallerBooleanTest extends BasicMarshallerTestCase2<BasicMarshallerBoolean, Boolean> {
    ...
    @Override
    BasicMarshallerBoolean marshaller() {
        return BasicMarshallerBoolean.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerBoolean> type() {
        return BasicMarshallerBoolean.class;
    }
}
