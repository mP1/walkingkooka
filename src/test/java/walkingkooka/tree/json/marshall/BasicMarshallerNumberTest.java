...
public final class BasicMarshallerNumberTest extends BasicMarshallerTestCase2<BasicMarshallerNumber, Number> {
    ...
    @Override
    BasicMarshallerNumber marshaller() {
        return BasicMarshallerNumber.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerNumber> type() {
        return BasicMarshallerNumber.class;
    }
}
