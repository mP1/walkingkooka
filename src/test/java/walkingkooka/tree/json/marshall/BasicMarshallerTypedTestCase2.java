...
public abstract class BasicMarshallerTypedTestCase2<M extends BasicMarshallerTyped<T>, T> extends BasicMarshallerTypedTestCase<M, T> {

    BasicMarshallerTypedTestCase2() {
        super();
    }
