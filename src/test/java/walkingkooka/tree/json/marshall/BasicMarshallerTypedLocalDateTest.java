...
public final class BasicMarshallerTypedLocalDateTest extends BasicMarshallerTypedTestCase2<BasicMarshallerTypedLocalDate, LocalDate> {
    ...
    @Override
    BasicMarshallerTypedLocalDate marshaller() {
        return BasicMarshallerTypedLocalDate.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedLocalDate> type() {
        return BasicMarshallerTypedLocalDate.class;
    }
}
