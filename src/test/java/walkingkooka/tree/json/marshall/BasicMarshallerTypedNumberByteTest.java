...
public final class BasicMarshallerTypedNumberByteTest extends BasicMarshallerTypedNumberTestCase<BasicMarshallerTypedNumberByte, Byte> {
    ...
    @Override
    BasicMarshallerTypedNumberByte marshaller() {
        return BasicMarshallerTypedNumberByte.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedNumberByte> type() {
        return BasicMarshallerTypedNumberByte.class;
    }
}
