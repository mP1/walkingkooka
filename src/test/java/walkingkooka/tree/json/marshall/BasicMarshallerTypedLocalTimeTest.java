...
public final class BasicMarshallerTypedLocalTimeTest extends BasicMarshallerTypedTestCase2<BasicMarshallerTypedLocalTime, LocalTime> {
    ...
    @Override
    BasicMarshallerTypedLocalTime marshaller() {
        return BasicMarshallerTypedLocalTime.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedLocalTime> type() {
        return BasicMarshallerTypedLocalTime.class;
    }
}
