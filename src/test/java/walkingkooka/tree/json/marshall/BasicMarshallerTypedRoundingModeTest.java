...
public final class BasicMarshallerTypedRoundingModeTest extends BasicMarshallerTypedTestCase<BasicMarshallerTypedRoundingMode, RoundingMode> {
    ...
    @Override
    BasicMarshallerTypedRoundingMode marshaller() {
        return BasicMarshallerTypedRoundingMode.instance();
    }
    ...
    @Override
    public Class<BasicMarshallerTypedRoundingMode> type() {
        return BasicMarshallerTypedRoundingMode.class;
    }
}
