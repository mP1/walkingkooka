...
public final class JsonNodeNameComparableTest extends ComparableTestCase<JsonNodeName> {
    ...
    @Override
    protected JsonNodeName createComparable() {
        return JsonNodeName.with("prop1");
    }
}
