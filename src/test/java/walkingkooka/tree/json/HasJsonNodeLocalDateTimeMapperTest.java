...
public final class HasJsonNodeLocalDateTimeMapperTest extends HasJsonNodeMapperTestCase2<HasJsonNodeLocalDateTimeMapper, LocalDateTime> {
    ...
    @Override
    HasJsonNodeLocalDateTimeMapper mapper() {
        return HasJsonNodeLocalDateTimeMapper.instance();
    }
    ...
    @Override
    public Class<HasJsonNodeLocalDateTimeMapper> type() {
        return HasJsonNodeLocalDateTimeMapper.class;
    }
}
