...
public final class TestNodePatchTest extends NodePatchTestCase2<TestNodePatch<JsonNode>> {
    ...
    @Override
    TestNodePatch<JsonNode> createPatch() {
        return TestNodePatch.with(NodePointer.named(this.property1(), JsonNode.class),
                this.value1());
    }
