...
public final class RemoveNodePatchTest extends NodePatchTestCase2<RemoveNodePatch<JsonNode>> {
    ...
    @Override
    RemoveNodePatch<JsonNode> createPatch() {
        return this.createPatch(this.property1());
    }
