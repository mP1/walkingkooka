...
public final class AddNodePatchTest extends NodePatchTestCase2<AddNodePatch<JsonNode>> {
    ...
    @Override
    AddNodePatch<JsonNode> createPatch() {
        return this.createPatch(this.property1(), this.value1());
    }
