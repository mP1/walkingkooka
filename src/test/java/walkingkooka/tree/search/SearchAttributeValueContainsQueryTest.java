...
public final class SearchAttributeValueContainsQueryTest extends SearchAttributeLeafQueryTestCase<SearchAttributeValueContainsQuery>{
    ...
    @Override
    SearchAttributeValueContainsQuery createSearchQuery(final SearchTextQueryValue queryValue,
                                                        final SearchNodeAttributeName attributeName,
                                                        final CaseSensitivity sensitivity) {
        return SearchAttributeValueContainsQuery.with(queryValue, attributeName, sensitivity);
    }
