...
public abstract class SearchBinaryQueryEqualityTestCase<Q extends SearchParentQuery> extends SearchQueryEqualityTestCase<Q> {

    @Test
    public void testDifferentLeftQuery() {
        this.checkNotEquals(this.createSearchQuery(this.differentQuery(), this.right()));
    }

    @Test
    public void testDifferentRightQuery() {
