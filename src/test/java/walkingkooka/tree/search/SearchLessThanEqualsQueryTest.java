...
public final class SearchLessThanEqualsQueryTest extends SearchValueComparisonLeafQueryTestCase<SearchLessThanEqualsQuery> {
    ...
    @Override
    public Class<SearchLessThanEqualsQuery> type() {
