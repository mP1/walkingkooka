...
public abstract class SearchQueryParentBinaryTestCase<Q extends SearchQueryParentBinary> extends SearchQueryParentTestCase<Q> {

    SearchQueryParentBinaryTestCase() {
        super();
    }
