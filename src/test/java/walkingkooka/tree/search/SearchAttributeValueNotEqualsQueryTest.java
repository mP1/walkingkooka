...
public final class SearchAttributeValueNotEqualsQueryTest extends SearchAttributeLeafQueryTestCase<SearchAttributeValueNotEqualsQuery> {
    ...
    @Override
    SearchAttributeValueNotEqualsQuery createSearchQuery(final SearchTextQueryValue queryValue,
                                                         final SearchNodeAttributeName attributeName,
                                                         final CaseSensitivity sensitivity) {
        return SearchAttributeValueNotEqualsQuery.with(queryValue, attributeName, sensitivity);
    }
