...
public final class SearchAttributeValueEqualsQueryTest extends SearchAttributeLeafQueryTestCase<SearchAttributeValueEqualsQuery>{
    ...
    @Override
    SearchAttributeValueEqualsQuery createSearchQuery(final SearchTextQueryValue queryValue,
                                                      final SearchNodeAttributeName attributeName,
                                                      final CaseSensitivity sensitivity) {
        return SearchAttributeValueEqualsQuery.with(queryValue, attributeName, sensitivity);
    }

    @Override
    protected Class<SearchAttributeValueEqualsQuery> type() {
        return SearchAttributeValueEqualsQuery.class;
    }
}
