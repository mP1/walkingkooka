...
public abstract class SearchQueryValueSearchQueryTesterComparableTestCase<T extends SearchQueryValueSearchQueryTesterComparable<V>,
        V extends Comparable<V>>
        extends SearchQueryTesterTestCase<T, V> {

    SearchQueryValueSearchQueryTesterComparableTestCase() {
        super();
    }
