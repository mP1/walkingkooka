...
public final class SearchLocalDateQueryValueEqualityTest extends SearchQueryValueEqualityTestCase<SearchLocalDateQueryValue, LocalDate> {
    @Override
    ...
    @Override
    LocalDate value() {
        return LocalDate.of(2000, 01, 31);
    }
