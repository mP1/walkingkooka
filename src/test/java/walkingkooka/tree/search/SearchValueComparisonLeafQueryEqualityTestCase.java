...
public abstract class SearchValueComparisonLeafQueryEqualityTestCase<Q extends SearchValueComparisonLeafQuery> extends SearchQueryEqualityTestCase<Q> {

    @Test
    public final void testDifferentQueryValue() {
        this.checkNotEquals(this.createSearchQuery(this.textQueryValue("different"), this.searchQueryTester()));
    }

    @Test
    public final void testDifferentSearchQueryTester() {
    ...
    final SearchQueryTester differentSearchQueryTester() {
        return SearchTextQueryValueSearchQueryTester.with(DIFFERENT_TEXT, CaseSensitivity.SENSITIVE, this.predicate());
    }
