...
public final class FontSizeTextStylePropertyValueHandlerTest extends TextStylePropertyValueHandlerTestCase<FontSizeTextStylePropertyValueHandler, FontSize> {
    ...
    @Override
    FontSizeTextStylePropertyValueHandler converter() {
    ...
    @Override
    public Class<FontSizeTextStylePropertyValueHandler> type() {
        return FontSizeTextStylePropertyValueHandler.class;
    }
}
