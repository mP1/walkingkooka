...
public final class TextStyleNodeTest extends TextParentNodeTestCase<TextStyleNode> {
    ...
    public void testJsonRoundtripWithProperties3() {
        ...
        properties.put(TextStylePropertyName.BORDER_WIDTH_BOTTOM, Length.pixel(1.0));
        properties.put(TextStylePropertyName.BORDER_WIDTH_LEFT, Length.pixel(2.0));
        properties.put(TextStylePropertyName.BORDER_WIDTH_RIGHT, Length.pixel(3.0));
        properties.put(TextStylePropertyName.BORDER_WIDTH_TOP, Length.pixel(4.0));
