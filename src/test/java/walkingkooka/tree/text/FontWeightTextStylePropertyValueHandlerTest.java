...
public final class FontWeightTextStylePropertyValueHandlerTest extends TextStylePropertyValueHandlerTestCase<FontWeightTextStylePropertyValueHandler, FontWeight> {
    ...
    @Override
    FontWeightTextStylePropertyValueHandler converter() {
    ...
    @Override
    public Class<FontWeightTextStylePropertyValueHandler> type() {
        return FontWeightTextStylePropertyValueHandler.class;
    }
}
