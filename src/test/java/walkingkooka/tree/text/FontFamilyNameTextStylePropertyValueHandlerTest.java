...
public final class FontFamilyNameTextStylePropertyValueHandlerTest extends TextStylePropertyValueHandlerTestCase<FontFamilyNameTextStylePropertyValueHandler, FontFamilyName> {
    ...
    @Override
    FontFamilyNameTextStylePropertyValueHandler converter() {
        return FontFamilyNameTextStylePropertyValueHandler.INSTANCE;
    }

    @Override
    TextStylePropertyName<FontFamilyName> propertyName() {
    ...
    @Override
    public Class<FontFamilyNameTextStylePropertyValueHandler> type() {
        return FontFamilyNameTextStylePropertyValueHandler.class;
    }
}
