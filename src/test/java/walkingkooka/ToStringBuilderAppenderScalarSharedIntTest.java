...
public final class ToStringBuilderAppenderScalarSharedIntTest extends ToStringBuilderAppenderScalarTestCase<ToStringBuilderAppenderScalarSharedInt, Integer> {
    ...
    @Override
    public Class<ToStringBuilderAppenderScalarSharedInt> type() {
        return ToStringBuilderAppenderScalarSharedInt.class;
    }
