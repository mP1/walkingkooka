...
public final class ToStringBuilderAppenderVectorOptionalIntTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorOptionalInt, OptionalInt> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorOptionalInt> type() {
        return ToStringBuilderAppenderVectorOptionalInt.class;
    }
}
