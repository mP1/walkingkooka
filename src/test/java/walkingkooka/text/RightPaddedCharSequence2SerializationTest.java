...
final public class RightPaddedCharSequence2SerializationTest
        extends SerializationTestCase<RightPaddedCharSequence2> {
    ...
    @Override
    protected RightPaddedCharSequence2 create() {
