...
final public class QuotesAroundCharSequenceSerializationTest
        extends SerializationTestCase<QuotesAroundCharSequence> {
    ...
    @Override
    protected QuotesAroundCharSequence create() {
