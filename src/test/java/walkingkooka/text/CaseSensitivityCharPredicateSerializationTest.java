...
final public class CaseSensitivityCharPredicateSerializationTest
        extends SerializationTestCase<CaseSensitivityCharPredicate> {

    @Override
    protected CaseSensitivityCharPredicate create() {
