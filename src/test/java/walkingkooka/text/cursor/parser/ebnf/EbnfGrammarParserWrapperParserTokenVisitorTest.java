...
public final class EbnfGrammarParserWrapperParserTokenVisitorTest implements ParserTokenVisitorTesting<EbnfGrammarParserWrapperParserTokenVisitor, ParserToken> {
    @Override
    public EbnfGrammarParserWrapperParserTokenVisitor createVisitor() {
        return new EbnfGrammarParserWrapperParserTokenVisitor();
    }
    ...
    @Override
    public Class<EbnfGrammarParserWrapperParserTokenVisitor> type() {
        return EbnfGrammarParserWrapperParserTokenVisitor.class;
    }
