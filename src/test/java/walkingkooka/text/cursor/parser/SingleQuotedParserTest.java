...
public final class SingleQuotedParserTest extends QuotedParserTestCase<SingleQuotedParser<TestParserContext>, SingleQuotedParserToken> {
    ...
    @Override
    protected Class<SingleQuotedParser<TestParserContext>> type() {
