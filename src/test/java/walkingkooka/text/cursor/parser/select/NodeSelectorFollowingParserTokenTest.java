...
public final class NodeSelectorFollowingParserTokenTest extends NodeSelectorLeafParserTokenTestCase2<NodeSelectorFollowingParserToken, String> {
    ...
    @Override
    protected Class<NodeSelectorFollowingParserToken> type() {
