...
public final class NodeSelectorDescendantParserTokenTest extends NodeSelectorLeafParserTokenTestCase2<NodeSelectorDescendantParserToken, String> {
    ...
    @Override
    protected Class<NodeSelectorDescendantParserToken> type() {
