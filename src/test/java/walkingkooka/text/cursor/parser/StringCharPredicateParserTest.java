...
public class StringCharPredicateParserTest extends ParserTemplateTestCase<StringCharPredicateParser<TestParserContext>, StringParserToken> {
    ...
    @Override
    protected Class<StringCharPredicateParser<TestParserContext>> type() {
