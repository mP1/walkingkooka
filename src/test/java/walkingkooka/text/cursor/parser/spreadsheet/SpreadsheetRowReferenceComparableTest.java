...
public final class SpreadsheetRowReferenceComparableTest extends LowerOrUpperTestCase<SpreadsheetRowReference> {
    ...
    @Override
    protected SpreadsheetRowReference createLowerOrUpper() {
