...
public final class SpreadsheetColumnReferenceComparableTest extends ComparableTestCase<SpreadsheetColumnReference> {
    ...
    @Override
    protected SpreadsheetColumnReference createComparable() {
