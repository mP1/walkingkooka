...
public final class SpreadsheetFormatTimeParserTokenTest extends SpreadsheetFormatParentParserTokenTestCase<SpreadsheetFormatTimeParserToken> {
    ...
    @Override
    protected Class<SpreadsheetFormatTimeParserToken> type() {
