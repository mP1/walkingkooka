...
public final class SpreadsheetFormatDayParserTokenTest extends SpreadsheetFormatLeafParserTokenTestCase<SpreadsheetFormatDayParserToken, String> {
    ...
    @Override
    protected Class<SpreadsheetFormatDayParserToken> type() {
