...
public final class SpreadsheetFormatDateParserTokenTest extends SpreadsheetFormatParentParserTokenTestCase<SpreadsheetFormatDateParserToken> {
    ...
    @Override
    protected Class<SpreadsheetFormatDateParserToken> type() {
