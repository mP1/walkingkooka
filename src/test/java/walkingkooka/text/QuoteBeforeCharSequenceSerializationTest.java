...
final public class QuoteBeforeCharSequenceSerializationTest
        extends SerializationTestCase<QuoteBeforeCharSequence> {
    ...
    @Override
    protected QuoteBeforeCharSequence create() {
