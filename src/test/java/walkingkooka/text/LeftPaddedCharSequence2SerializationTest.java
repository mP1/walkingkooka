...
final public class LeftPaddedCharSequence2SerializationTest
        extends SerializationTestCase<LeftPaddedCharSequence2> {
    ...
    @Override
    protected LeftPaddedCharSequence2 create() {
