...
final public class RightPaddedCharSequenceSerializationTest
        extends SerializationTestCase<RightPaddedCharSequence> {
    ...
    @Override
    protected RightPaddedCharSequence create() {
