...
public class ToStringBuilderAppenderVectorArrayShared2IntTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorArrayShared2Int, int[]> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorArrayShared2Int> type() {
        return ToStringBuilderAppenderVectorArrayShared2Int.class;
    }
}
