...
public final class OpaqueColorEqualityTest extends ColorEqualityTestCase<Color> {
    ...
    @Override
    Color createColor(final RedColorComponent red, final GreenColorComponent green, final BlueColorComponent blue) {
