...
public final class SaturationHsvComponentSerializationTest extends SerializationTestCase<SaturationHsvComponent> {
    ...
    @Override
    protected SaturationHsvComponent create() {
