...
public final class SaturationHslComponentSerializationTest extends SerializationTestCase<SaturationHslComponent> {
    ...
    @Override
    protected SaturationHslComponent create() {
