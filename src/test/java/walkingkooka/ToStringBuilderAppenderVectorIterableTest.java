...
public final class ToStringBuilderAppenderVectorIterableTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorIterable, Iterable<?>> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorIterable> type() {
        return ToStringBuilderAppenderVectorIterable.class;
    }
}
