...
public final class ToStringBuilderAppenderVectorArrayShared2FloatTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorArrayShared2Float, float[]> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorArrayShared2Float> type() {
        return ToStringBuilderAppenderVectorArrayShared2Float.class;
    }
}
