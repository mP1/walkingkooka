...
public final class ToStringBuilderAppenderVectorOptionalTest extends ToStringBuilderAppenderVectorTestCase<ToStringBuilderAppenderVectorOptional<Object>, Optional<Object>> {
    ...
    @Override
    public Class<ToStringBuilderAppenderVectorOptional<Object>> type() {
        return Cast.to(ToStringBuilderAppenderVectorOptional.class);
    }
}
