...
public final class ContentRangeHttpHeaderValueConverterTest extends
        HttpHeaderValueConverterTestCase<ContentRangeHttpHeaderValueConverter, ContentRange> {
    ...
    @Override
    protected ContentRangeHttpHeaderValueConverter converter() {
    ...
    @Override
    protected Class<ContentRangeHttpHeaderValueConverter> type() {
        return ContentRangeHttpHeaderValueConverter.class;
    }
}
