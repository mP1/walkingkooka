...
public final class HttpETagTest extends PublicClassTestCase<HttpETag> {
    ...
    private final static Optional<HttpETagWeak> WEAK = Optional.of(HttpETagWeak.WEAK);
    ...
    public void testWithNullValueFails() {
        HttpETag.with(null, HttpETag.NO_WEAK);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testWithInvalidValueCharacterFails() {
        HttpETag.with("abc def", HttpETag.NO_WEAK);
    }
    ...
    public void testToString() {
        assertEquals("\"abc123\"", HttpETag.with("abc123", HttpETag.NO_WEAK).toString());
    }
    ...
    public void testToStringListOfOne() {
        this.toStringAndCheck("\"abc123\"",
                HttpETag.with("abc123", HttpETag.NO_WEAK));
    }

    @Test
    public void testToStringListOfOne2() {
        this.toStringAndCheck("W/\"abc123\"",
                HttpETag.with("abc123", HttpETag.WEAK));
    }
    ...
    public void testToStringListOfMany() {
        this.toStringAndCheck("\"1\", \"2\"",
                HttpETag.with("1", HttpETag.NO_WEAK),
                HttpETag.with("2", HttpETag.NO_WEAK));
    }

    @Test
    public void testToStringListOfMany2() {
        this.toStringAndCheck("\"11\", \"22\"",
                HttpETag.with("11", HttpETag.NO_WEAK),
                HttpETag.with("22", HttpETag.NO_WEAK));
    }

    @Test
    public void testToStringListOfMany3() {
        this.toStringAndCheck("W/\"11\", \"22\"",
                HttpETag.with("11", HttpETag.WEAK),
                HttpETag.with("22", HttpETag.NO_WEAK));
    }
