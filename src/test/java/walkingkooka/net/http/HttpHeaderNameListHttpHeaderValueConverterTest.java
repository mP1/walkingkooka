...
public final class HttpHeaderNameListHttpHeaderValueConverterTest extends
        HttpHeaderValueConverterTestCase<HttpHeaderNameListHttpHeaderValueConverter, List<HttpHeaderName<?>>> {
    ...
    @Override
    protected HttpHeaderNameListHttpHeaderValueConverter converter() {
    ...
    @Override
    protected Class<HttpHeaderNameListHttpHeaderValueConverter> type() {
        return HttpHeaderNameListHttpHeaderValueConverter.class;
    }
}
