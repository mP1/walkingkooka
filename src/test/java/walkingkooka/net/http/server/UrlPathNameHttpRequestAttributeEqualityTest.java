...
public final class UrlPathNameHttpRequestAttributeEqualityTest extends HashCodeEqualsDefinedEqualityTestCase<UrlPathNameHttpRequestAttribute> {
    ...
    @Override
    protected UrlPathNameHttpRequestAttribute createObject() {
