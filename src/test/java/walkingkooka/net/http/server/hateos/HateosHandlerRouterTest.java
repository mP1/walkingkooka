...
public final class HateosHandlerRouterTest extends HateosHandlerRouterTestCase<HateosHandlerRouter<JsonNode>>
    ...
    private final static HateosIdResourceValueHandler<BigInteger, TestHateosResource, TestHateosResource2> HATEOS_VALUE_HANDLER = new FakeHateosIdResourceValueHandler<>();
    ...
    private void routeGetAndCheck(final String url,
        ...
        this.routeAndCheck(this.builder().add(this.resourceName1(), this.relation1(), this.mapper().get(HATEOS_RESOURCE_HANDLER)),
                ...
                status,
                entities);
        this.routeAndCheck(this.builder().add(this.resourceName1(), this.relation1(), this.mapper().get(HATEOS_VALUE_HANDLER)),
                url,
                status,
                entities);
    }
    ...
    private void routeHateosIdResourceValueHandlerPostAndCheck(final String url,
                                                                ...
                                                                final HttpStatus status,
                                                                final HttpEntity... entities) {
        this.routeAndCheck(this.builder().add(this.resourceName1(), this.relation1(), this.mapper().post(HATEOS_VALUE_HANDLER)),
                HttpMethod.POST,
                url,
                this.contentType(),
                requestBody,
