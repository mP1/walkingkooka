...
public final class ClientCookieListHttpHeaderValueConverterTest extends
        HttpHeaderValueConverterTestCase<ClientCookieListHttpHeaderValueConverter, List<ClientCookie>> {
    ...
    @Override
    protected Class<ClientCookieListHttpHeaderValueConverter> type() {
        return ClientCookieListHttpHeaderValueConverter.class;
    }
}
