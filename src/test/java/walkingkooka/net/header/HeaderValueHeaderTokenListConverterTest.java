...
public final class HeaderValueHeaderTokenListConverterTest extends
        HeaderValueConverterTestCase<HeaderValueHeaderTokenListConverter, List<HeaderToken>> {
    ...
    @Override
    protected HeaderValueHeaderTokenListConverter converter() {
    ...
    @Override
    protected Class<HeaderValueHeaderTokenListConverter> type() {
        return HeaderValueHeaderTokenListConverter.class;
    }
}
