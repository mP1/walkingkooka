...
public final class HeaderValueUrlConverterTest extends
        HeaderValueConverterTestCase<HeaderValueUrlConverter, Url> {
    ...
    @Override
    protected HeaderValueUrlConverter converter() {
    ...
    @Override
    protected Class<HeaderValueUrlConverter> type() {
        return HeaderValueUrlConverter.class;
    }
}
