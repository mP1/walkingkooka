...
public final class UrlHeaderValueHandlerTest extends NonStringHeaderValueHandlerTestCase<UrlHeaderValueHandler, Url> {
    ...
    @Override
    protected UrlHeaderValueHandler handler() {
    ...
    @Override
    public Class<UrlHeaderValueHandler> type() {
        return UrlHeaderValueHandler.class;
    }
}
