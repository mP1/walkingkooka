...
final public class CharsetHeaderTest extends HeaderValueWithParametersTestCase<MediaType, MediaTypeParameterName<?>> {
    ...
    public void testWithWildcardTypeAndWildcardSubType() {
        check(MediaType.with(MediaType.WILDCARD.string(), MediaType.WILDCARD.string()),
                MediaType.WILDCARD.string(),
                MediaType.WILDCARD.string());
    }
