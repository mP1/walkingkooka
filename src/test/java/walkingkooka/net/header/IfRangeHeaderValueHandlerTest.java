...
public final class IfRangeHeaderValueHandlerTest extends
        NonStringHeaderValueHandlerTestCase<IfRangeHeaderValueHandler, IfRange<?>> {
    ...
    @Override
    IfRangeHeaderValueHandler handler() {
    ...
    @Override
    public Class<IfRangeHeaderValueHandler> type() {
        return IfRangeHeaderValueHandler.class;
    }
}
