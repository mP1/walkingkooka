...
public final class CharsetNameHeaderValueHandlerTest extends
        NonStringHeaderValueHandlerTestCase<CharsetNameHeaderValueHandler, CharsetName> {
    ...
    @Override
    CharsetNameHeaderValueHandler handler() {
    ...
    @Override
    public Class<CharsetNameHeaderValueHandler> type() {
        return CharsetNameHeaderValueHandler.class;
    }
}
