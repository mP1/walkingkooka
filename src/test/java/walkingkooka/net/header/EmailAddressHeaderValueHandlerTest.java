...
public final class EmailAddressHeaderValueHandlerTest extends
        NonStringHeaderValueHandlerTestCase<EmailAddressHeaderValueHandler, EmailAddress> {
    ...
    @Override
    EmailAddressHeaderValueHandler handler() {
    ...
    @Override
    public Class<EmailAddressHeaderValueHandler> type() {
        return EmailAddressHeaderValueHandler.class;
    }
}
