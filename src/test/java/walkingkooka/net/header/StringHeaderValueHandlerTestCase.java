...
public abstract class StringHeaderValueHandlerTestCase<C extends StringHeaderValueHandler> extends HeaderValueHandlerTestCase2<C, String> {

    StringHeaderValueHandlerTestCase() {
        super();
    }
