...
public final class ContentEncodingListHeaderParserTest extends HeaderParserTestCase<ContentEncodingListHeaderParser, List<ContentEncoding>>{
    ...
    @Override
    public Class<ContentEncodingListHeaderParser> type() {
        return ContentEncodingListHeaderParser.class;
    }
}
