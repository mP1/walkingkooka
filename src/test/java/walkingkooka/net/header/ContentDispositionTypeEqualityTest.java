...
final public class ContentDispositionTypeEqualityTest extends HashCodeEqualsDefinedEqualityTestCase<ContentDispositionType> {
    ...
    @Override
    protected ContentDispositionType createObject() {
