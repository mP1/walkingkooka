...
public final class HttpMethodHeaderValueHandlerTest extends
        NonStringHeaderValueHandlerTestCase<HttpMethodHeaderValueHandler, HttpMethod> {
    ...
    @Override
    HttpMethodHeaderValueHandler handler() {
    ...
    @Override
    public Class<HttpMethodHeaderValueHandler> type() {
        return HttpMethodHeaderValueHandler.class;
    }
}
