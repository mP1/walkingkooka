...
public final class HeaderValueLocalDateTimeConverterTest extends
        HeaderValueConverterTestCase<HeaderValueLocalDateTimeConverter, LocalDateTime> {
    ...
    @Override
    protected HeaderValueLocalDateTimeConverter converter() {
    ...
    @Override
    protected Class<HeaderValueLocalDateTimeConverter> type() {
        return HeaderValueLocalDateTimeConverter.class;
    }
}
