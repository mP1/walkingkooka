...
public final class AcceptEncodingListHeaderParserTest extends HeaderParserTestCase<AcceptEncodingListHeaderParser, List<AcceptEncoding>> {
    ...
    @Override
    public Class<AcceptEncodingListHeaderParser> type() {
        return AcceptEncodingListHeaderParser.class;
    }
}
