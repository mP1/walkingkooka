...
public final class ToStringBuilderAppenderScalarSharedDoubleTest extends ToStringBuilderAppenderScalarTestCase<ToStringBuilderAppenderScalarSharedDouble, Double> {
    ...
    @Override
    public Class<ToStringBuilderAppenderScalarSharedDouble> type() {
        return ToStringBuilderAppenderScalarSharedDouble.class;
    }
}
