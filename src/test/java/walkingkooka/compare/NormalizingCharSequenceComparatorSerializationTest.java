...
final public class NormalizingCharSequenceComparatorSerializationTest
        extends SerializationTestCase<NormalizingCharSequenceComparator<String>> {
    ...
    @Override
    protected NormalizingCharSequenceComparator<String> create() {
