...
public final class ComparatorTestingTest implements ComparatorTesting<Comparator<String>, String> {
    ...
    @Test
    public void testComparatorCompareAndCheckLess() {
    ...
    public void testCompareAndCheckEqualsFails() {
        this.mustFail(() -> this.compareAndCheckEquals(VALUE, MORE));
    }
    ...
    public void testCompareAndCheckMoreFails() {
        this.mustFail(() -> this.compareAndCheckMore(VALUE, MORE));
    }

    @Test
    public void testComparatorCompareAndCheckMore() {
    ...
    public void testCompareAndCheckAndMore() {
        this.compareAndCheck(COMPARATOR,
                VALUE,
                MORE,
                -1);
    }
    ...
    public void testCompareAndCheckAndMoreFail() {
        this.mustFail(() -> this.compareAndCheck(COMPARATOR,
                VALUE,
                LESS,
                0));
    }
