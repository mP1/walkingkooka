...
final public class CustomToStringPredicateSerializationTest
        extends SerializationTestCase<CustomToStringPredicate<String>> {

    @Override
    protected CustomToStringPredicate<String> create() {
