...
final public class CharPredicatePredicateEqualityTest
    ...
    public void testDifferentCharacterPredicate() {
        this.checkNotEquals(CharacterPredicatePredicate.adapt(CharPredicates.never()));
    }

    @Override
    protected CharacterPredicatePredicate createObject() {
        return CharacterPredicatePredicate.adapt(CharPredicatePredicateEqualityTest.PREDICATE);
    }
}
