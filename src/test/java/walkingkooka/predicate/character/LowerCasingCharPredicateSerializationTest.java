...
final public class LowerCasingCharPredicateSerializationTest
        extends SerializationTestCase<LowerCasingCharPredicate> {

    @Override
    protected LowerCasingCharPredicate create() {
