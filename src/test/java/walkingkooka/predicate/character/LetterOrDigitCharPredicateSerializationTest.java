...
final public class LetterOrDigitCharPredicateSerializationTest
        extends SerializationTestCase<LetterOrDigitCharPredicate> {

    @Override
    protected LetterOrDigitCharPredicate create() {
