...
abstract public class LogicalCharPredicateEqualityTestCase<M extends CharPredicate & HashCodeEqualsDefined>
    ...
    @Test final public void testDifferentFirstCharacterPredicate() {
        this.checkNotEquals(this.createObject(CharPredicates.is('d'), CharPredicates.is('r')));
    }

    @Test final public void testDifferentSecondCharacterPredicate() {
        this.checkNotEquals(this.createObject(CharPredicates.is('l'), CharPredicates.is('d')));
    }
