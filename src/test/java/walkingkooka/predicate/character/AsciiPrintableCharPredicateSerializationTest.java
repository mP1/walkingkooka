...
final public class AsciiPrintableCharPredicateSerializationTest
        extends SerializationTestCase<AsciiPrintableCharPredicate> {

    @Override
    protected AsciiPrintableCharPredicate create() {
