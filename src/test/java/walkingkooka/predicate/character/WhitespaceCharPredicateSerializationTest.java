...
final public class WhitespaceCharPredicateSerializationTest
        extends SerializationTestCase<WhitespaceCharPredicate> {

    @Override
    protected WhitespaceCharPredicate create() {
