...
final public class AsciiControlCharPredicateSerializationTest
        extends SerializationTestCase<AsciiControlCharPredicate> {

    @Override
    protected AsciiControlCharPredicate create() {
