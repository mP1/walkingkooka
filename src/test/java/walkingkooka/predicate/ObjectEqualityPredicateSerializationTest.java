...
final public class ObjectEqualityPredicateSerializationTest
        extends SerializationTestCase<ObjectEqualityPredicate<String>> {

    @Override
    protected ObjectEqualityPredicate<String> create() {
