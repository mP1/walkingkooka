...
public final class IntegerWrapperArrayToStringBuilderTest extends VectorToStringBuilderTestCase<Integer[]> {

    @Test
    public void testValueIncludesDefault(){
        final ToStringBuilder b = this.builder();
        b.label(LABEL);
        b.value(new Integer[]{0, 1, 2});
    ...
    public void testValueHexWholeNumber() {
        ...
        this.buildAndCheck(b, "00000000, 00000001, 00000002");
    }
