...
public abstract class ParserBiFunctionTestCase2<F extends BiFunction<SequenceParserToken, FakeParserContext, TOUT>,
        TOUT extends ParserToken>
        extends ParserBiFunctionTestCase<F, FakeParserContext, TOUT> {
