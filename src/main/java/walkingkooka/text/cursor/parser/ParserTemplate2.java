 ...
 * on failures.
 */
abstract class ParserTemplate2<T extends ParserToken, C extends ParserContext> extends ParserTemplate<T, C> {

    @Override
    final Optional<T> tryParse(final TextCursor cursor, final C context) {
