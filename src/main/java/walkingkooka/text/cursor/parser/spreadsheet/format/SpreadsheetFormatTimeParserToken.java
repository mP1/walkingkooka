...
public final class SpreadsheetFormatTimeParserToken extends SpreadsheetFormatParentParserToken<SpreadsheetFormatTimeParserToken> {
    ...
    static SpreadsheetFormatTimeParserToken with(final List<ParserToken> value, final String text) {
        ...
        return new SpreadsheetFormatTimeParserToken(copy,
                text,
    ...
    @Override
    public SpreadsheetFormatTimeParserToken setText(final String text) {
        return this.setText0(text).cast();
    }

    @Override
    public SpreadsheetFormatTimeParserToken setValue(final List<ParserToken> values) {
