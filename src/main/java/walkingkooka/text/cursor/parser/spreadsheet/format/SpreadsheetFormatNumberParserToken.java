...
public final class SpreadsheetFormatNumberParserToken extends SpreadsheetFormatParentParserToken<SpreadsheetFormatNumberParserToken> {
    ...
    public final static ParserTokenNodeName NAME = ParserTokenNodeName.fromClass(SpreadsheetFormatNumberParserToken.class);
    ...
    static SpreadsheetFormatNumberParserToken with(final List<ParserToken> value, final String text) {
        ...
        return new SpreadsheetFormatNumberParserToken(copy,
                text,
     ...
     */
    private SpreadsheetFormatNumberParserToken(final List<ParserToken> value, final String text, final List<ParserToken> valueWithout) {
    ...
    @Override
    public SpreadsheetFormatNumberParserToken setText(final String text) {
        return this.setText0(text).cast();
    }

    @Override
    public SpreadsheetFormatNumberParserToken setValue(final List<ParserToken> values) {
    ...
    SpreadsheetFormatParentParserToken replace(final List<ParserToken> tokens, final String text, final List<ParserToken> without) {
        return new SpreadsheetFormatNumberParserToken(tokens, text, without);
    }
