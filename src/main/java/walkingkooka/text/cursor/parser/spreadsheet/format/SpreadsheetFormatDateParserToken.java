...
public final class SpreadsheetFormatDateParserToken extends SpreadsheetFormatParentParserToken<SpreadsheetFormatDateParserToken> {
    ...
    public final static ParserTokenNodeName NAME = ParserTokenNodeName.fromClass(SpreadsheetFormatDateParserToken.class);
    ...
    static SpreadsheetFormatDateParserToken with(final List<ParserToken> value, final String text) {
        ...
        return new SpreadsheetFormatDateParserToken(copy,
                text,
    ...
    @Override
    public SpreadsheetFormatDateParserToken setText(final String text) {
        return this.setText0(text).cast();
    }

    @Override
    public SpreadsheetFormatDateParserToken setValue(final List<ParserToken> values) {
