 ...
 */
final public class NodeSelectorAttributeName implements Name, HashCodeEqualsDefined {
    ...
    public static NodeSelectorAttributeName with(final String name) {
        ...
        if (length > MAX_LENGTH) {
            throw new IllegalArgumentException("Attribute name length " + length + " greater than allowed of " + MAX_LENGTH);
        }
    ...
    public final boolean equals(final Object other) {
        return (this == other) || other instanceof NodeSelectorAttributeName && this.equals0((NodeSelectorAttributeName) other);
    }

    private boolean equals0(final NodeSelectorAttributeName other) {
