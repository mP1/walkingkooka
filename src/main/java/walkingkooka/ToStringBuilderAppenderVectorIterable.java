...
final class ToStringBuilderAppenderVectorIterable extends ToStringBuilderAppenderVector<Iterable<?>> {

    static ToStringBuilderAppenderVectorIterable with(final Iterable<?> value) {
        return new ToStringBuilderAppenderVectorIterable(value);
    }

    private ToStringBuilderAppenderVectorIterable(final Iterable<?> value) {
        super(value);
