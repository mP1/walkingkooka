 ...
 */
final class SingletonImmutableList<T> extends ImmutableList<T> {

    /**
     * Returns a {@link List} which is immutable.
     */
    static <T> SingletonImmutableList<T> with(final T element) {
     ...
     */
    private SingletonImmutableList(final T element) {
        super();
