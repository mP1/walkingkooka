...
final class BasicToJsonNodeContext extends BasicJsonNodeContext implements ToJsonNodeContext {
    ...
    public JsonNode toJsonNode(final Object value) {
        return null == value ?
                JsonNode.nullNode() :
                BasicMapper.mapperOrFail(value.getClass())
    ...
    private JsonNode entry(final Entry<?, ?> entry) {
        return JsonNode.object()
                .set(BasicMapperTypedMap.ENTRY_KEY, this.toJsonNode(entry.getKey()))
                .set(BasicMapperTypedMap.ENTRY_VALUE, this.toJsonNode(entry.getValue()));
    }
    ...
    public JsonNode toJsonNodeWithTypeList(final List<?> list) {
        return BasicMapperTypedCollectionList.instance().toJsonNode(list, this);
    }
    ...
    public JsonNode toJsonNodeWithTypeSet(final Set<?> set) {
        return BasicMapperTypedCollectionSet.instance().toJsonNode(set, this);
    }
    ...
    public JsonNode toJsonNodeWithTypeMap(final Map<?, ?> map) {
        return BasicMapperTypedMap.instance().toJsonNode(map, this);
    }
}
