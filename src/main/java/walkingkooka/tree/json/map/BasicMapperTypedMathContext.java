 ...
 */
final class BasicMapperTypedMathContext extends BasicMapperTyped<MathContext> {

    static BasicMapperTypedMathContext instance() {
        return new BasicMapperTypedMathContext();
    }

    private BasicMapperTypedMathContext() {
        super();
    }
