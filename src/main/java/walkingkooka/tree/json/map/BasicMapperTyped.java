...
/**
 * A {@link BasicMapper} that includes a json object with the type name and the actual jsonized value.
 * This is mostly used for in built JDK types that cannot be altered.
 */
abstract class BasicMapperTyped<T> extends BasicMapper<T> {
