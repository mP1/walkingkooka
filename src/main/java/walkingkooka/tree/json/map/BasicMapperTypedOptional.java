 ...
 */
final class BasicMapperTypedOptional extends BasicMapperTyped<Optional<?>> {

    static BasicMapperTypedOptional instance() {
        return new BasicMapperTypedOptional();
    }

    /**
     * Private ctor use factory.
     */
    private BasicMapperTypedOptional() {
        super();
    }
