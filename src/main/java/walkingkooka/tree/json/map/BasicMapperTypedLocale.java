 ...
 */
final class BasicMapperTypedLocale extends BasicMapperTyped<Locale> {

    static BasicMapperTypedLocale instance() {
        return new BasicMapperTypedLocale();
    }

    private BasicMapperTypedLocale() {
        super();
    }
