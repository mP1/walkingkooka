...
final class BasicMapperTypedCharacter extends BasicMapperTyped<Character> {

    static BasicMapperTypedCharacter instance() {
        return new BasicMapperTypedCharacter();
    }

    private BasicMapperTypedCharacter() {
        super();
    }
