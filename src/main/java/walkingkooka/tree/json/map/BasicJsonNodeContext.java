...
/**
 * A {@link JsonNodeContext} that contains shared methods and attributes for both {@link BasicFromJsonNodeContext} and
...
abstract class BasicJsonNodeContext implements JsonNodeContext {
    ...
    public final Optional<Class<?>> registeredType(final JsonStringNode name) {
        return BasicMapper.registeredType(name);
    }
    ...
    public final Optional<JsonStringNode> typeName(final Class<?> type) {
        return BasicMapper.typeName(type);
    }
    ...
    public final String toString() {
        ...
        sorted.addAll(BasicMapper.TYPENAME_TO_FACTORY.keySet());
