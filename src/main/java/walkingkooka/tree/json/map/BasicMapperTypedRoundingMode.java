 ...
 */
final class BasicMapperTypedRoundingMode extends BasicMapperTyped<RoundingMode> {

    static BasicMapperTypedRoundingMode instance() {
        return new BasicMapperTypedRoundingMode();
    }

    private BasicMapperTypedRoundingMode() {
        super();
    }
