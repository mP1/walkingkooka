...
final class BasicMapperTypedNumberLong extends BasicMapperTyped<Long> {

    static BasicMapperTypedNumberLong instance() {
        return new BasicMapperTypedNumberLong();
    }

    private BasicMapperTypedNumberLong() {
        super();
    }
