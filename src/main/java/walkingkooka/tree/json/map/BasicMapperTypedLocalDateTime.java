...
final class BasicMapperTypedLocalDateTime extends BasicMapperTyped<LocalDateTime> {

    static BasicMapperTypedLocalDateTime instance() {
        return new BasicMapperTypedLocalDateTime();
    }

    private BasicMapperTypedLocalDateTime() {
        super();
    }
