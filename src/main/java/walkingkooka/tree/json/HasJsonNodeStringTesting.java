...
public interface HasJsonNodeStringTesting<H extends HasJsonNode> extends HasJsonNodeTesting<H> {

    @Test
    default void testFromJsonNodeArrayFails() {
        this.fromJsonNodeFails(JsonNode.array(), JsonNodeException.class);
    }

    @Test
    default void testFromJsonNodeBooleanFails() {
        this.fromJsonNodeFails(JsonNode.booleanNode(true), JsonNodeException.class);
    }

    @Test
    default void testFromJsonNodeNumberFails() {
        this.fromJsonNodeFails(JsonNode.number(1.25), JsonNodeException.class);
    }

    @Test
    default void testFromJsonNodeObjectFails() {
