 ...
 */
final class BasicMarshallerTypedRoundingMode extends BasicMarshallerTyped<RoundingMode> {

    static BasicMarshallerTypedRoundingMode instance() {
        return new BasicMarshallerTypedRoundingMode();
    }

    private BasicMarshallerTypedRoundingMode() {
        super();
    }
    ...
    @Override
    RoundingMode fromJsonNodeNull(final FromJsonNodeContext context) {
        return null;
    }
