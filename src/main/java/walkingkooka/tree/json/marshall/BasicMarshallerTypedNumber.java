...
/**
 * Base for a {@link BasicMarshaller} that holds a number value wrapped inside a JSON object with the type.
 */
abstract class BasicMarshallerTypedNumber<T extends Number> extends BasicMarshallerTyped<T> {

    BasicMarshallerTypedNumber() {
        super();
    }
