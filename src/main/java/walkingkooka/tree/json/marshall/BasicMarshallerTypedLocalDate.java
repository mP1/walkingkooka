...
final class BasicMarshallerTypedLocalDate extends BasicMarshallerTyped<LocalDate> {

    static BasicMarshallerTypedLocalDate instance() {
        return new BasicMarshallerTypedLocalDate();
    }

    private BasicMarshallerTypedLocalDate() {
        super();
    }
