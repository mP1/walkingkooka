...
final class BasicJsonMarshallerTypedExpressionNodeReference extends BasicJsonMarshallerTypedExpressionNode<ExpressionReferenceNode> {
    ...
    @Override
    ExpressionReferenceNode fromJsonNodeNonNull(final JsonNode node,
                                                final FromJsonNodeContext context) {
        return ExpressionNode.reference(context.fromJsonNodeWithType(node));
    }

    @Override
    JsonNode toJsonNodeNonNull(final ExpressionReferenceNode value,
                               final ToJsonNodeContext context) {
        return context.toJsonNodeWithType(value.value());
    }
}
