...
/**
 * A {@link BasicMarshallerTyped} that handles {@link JsonNode}.
 */
final class BasicMarshallerTypedJsonNode extends BasicMarshallerTyped<JsonNode> {

    static BasicMarshallerTypedJsonNode instance() {
        return new BasicMarshallerTypedJsonNode();
    }

    private BasicMarshallerTypedJsonNode() {
        super();
    }
