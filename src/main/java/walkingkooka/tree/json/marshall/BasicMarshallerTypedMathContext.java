 ...
 */
final class BasicMarshallerTypedMathContext extends BasicMarshallerTyped<MathContext> {

    static BasicMarshallerTypedMathContext instance() {
        return new BasicMarshallerTypedMathContext();
    }

    private BasicMarshallerTypedMathContext() {
        super();
    }
    ...
    @Override
    MathContext fromJsonNodeNull(final FromJsonNodeContext context) {
        return null;
    }
