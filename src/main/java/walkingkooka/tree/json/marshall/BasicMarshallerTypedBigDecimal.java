...
final class BasicMarshallerTypedBigDecimal extends BasicMarshallerTyped<BigDecimal> {

    static BasicMarshallerTypedBigDecimal instance() {
        return new BasicMarshallerTypedBigDecimal();
    }

    private BasicMarshallerTypedBigDecimal() {
        super();
    }
