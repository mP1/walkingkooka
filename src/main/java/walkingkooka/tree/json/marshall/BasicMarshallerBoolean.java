...
final class BasicMarshallerBoolean extends BasicMarshaller<Boolean> {

    static BasicMarshallerBoolean instance() {
        return new BasicMarshallerBoolean();
    }

    private BasicMarshallerBoolean() {
        super();
    }
