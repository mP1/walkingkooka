...
final class BasicMarshallerTypedMap extends BasicMarshallerTyped<Map<?, ?>> {

    static BasicMarshallerTypedMap instance() {
        return new BasicMarshallerTypedMap();
    }

    private BasicMarshallerTypedMap() {
        super();
    }
