...
final class BasicMarshallerNumber extends BasicMarshaller<Number> {

    static BasicMarshallerNumber instance() {
        return new BasicMarshallerNumber();
    }

    private BasicMarshallerNumber() {
        super();
    }
