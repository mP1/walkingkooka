 ...
 */
final class BasicMarshallerTypedOptional extends BasicMarshallerTyped<Optional<?>> {

    static BasicMarshallerTypedOptional instance() {
        return new BasicMarshallerTypedOptional();
    }

    /**
     * Private ctor use factory.
     */
    private BasicMarshallerTypedOptional() {
        super();
    }
