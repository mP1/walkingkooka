...
final class BasicMarshallerTypedBigInteger extends BasicMarshallerTyped<BigInteger> {

    static BasicMarshallerTypedBigInteger instance() {
        return new BasicMarshallerTypedBigInteger();
    }

    private BasicMarshallerTypedBigInteger() {
        super();
    }
