 ...
 */
public final class SearchDoubleQueryValue extends SearchNumberQueryValue<Double> {

    static SearchDoubleQueryValue with(final Double value) {
        check(value);
        return new SearchDoubleQueryValue(value);
    }

    private SearchDoubleQueryValue(final Double value) {
        super(value);
    }
