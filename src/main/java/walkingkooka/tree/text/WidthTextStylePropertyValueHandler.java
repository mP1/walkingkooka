 ...
 */
final class WidthTextStylePropertyValueHandler extends TextStylePropertyValueHandler<Height> {

    /**
     * Singleton
     */
    final static WidthTextStylePropertyValueHandler INSTANCE = new WidthTextStylePropertyValueHandler();

    /**
     * Private ctor
     */
    private WidthTextStylePropertyValueHandler() {
        super();
    }
