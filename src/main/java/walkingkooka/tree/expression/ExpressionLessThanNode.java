...
public final class ExpressionLessThanNode extends ExpressionComparisonBinaryNode {
    ...
    @Override
    public ExpressionLessThanNode removeParent() {
        return this.removeParent0().cast();
    }

    @Override
    public ExpressionLessThanNode setChildren(final List<ExpressionNode> children) {
    ...
    static ExpressionLessThanNode fromJsonNode(final JsonNode node) {
        return fromJsonNode0(node, ExpressionLessThanNode::with);
    }

    static {
        register(SYMBOL, ExpressionLessThanNode::fromJsonNode, ExpressionLessThanNode.class);
    }
    ...
    boolean canBeEqual(final Object other) {
        return other instanceof ExpressionLessThanNode;
    }
