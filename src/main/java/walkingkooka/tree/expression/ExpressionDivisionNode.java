 ...
 */
public final class ExpressionDivisionNode extends ExpressionBinaryNode {
    ...
    @Override
    ExpressionDivisionNode wrap1(final int index, final ExpressionNode left, final ExpressionNode right) {
