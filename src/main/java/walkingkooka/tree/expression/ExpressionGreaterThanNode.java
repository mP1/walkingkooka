...
public final class ExpressionGreaterThanNode extends ExpressionBinaryNode {
    ...
    @Override
    ExpressionGreaterThanNode wrap1(final int index, final ExpressionNode left, final ExpressionNode right) {
