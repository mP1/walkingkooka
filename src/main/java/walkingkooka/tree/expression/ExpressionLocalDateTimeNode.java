...
public final class ExpressionLocalDateTimeNode extends ExpressionValueNode<LocalDateTime> {
    ...
    static ExpressionLocalDateTimeNode fromJsonNode(final JsonNode node) {
        return ExpressionLocalDateTimeNode.with(HasJsonNode.fromJsonNode(node, LocalDateTime.class));
    }

    static {
        register("-local-date-time", ExpressionLocalDateTimeNode::fromJsonNode, ExpressionLocalDateTimeNode.class);
    }
