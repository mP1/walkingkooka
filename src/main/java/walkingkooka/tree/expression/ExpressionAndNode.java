...
public final class ExpressionAndNode extends ExpressionLogicalBinaryNode {
    ...
    ExpressionNode applyBigInteger(final BigInteger left, final BigInteger right, final ExpressionEvaluationContext context) {
        return ExpressionNode.bigInteger(left.and(right));
    }
    ...
    // @VisibleForTesting
    static ExpressionAndNode fromJsonNode(final JsonNode node,
                                          final FromJsonNodeContext context) {
        return fromJsonNode0(node,
                ExpressionAndNode::with,
                context);
    }

    static {
        register(SYMBOL,
                ExpressionAndNode::fromJsonNode,
                ExpressionAndNode::toJsonNode,
                ExpressionAndNode.class);
    }
    ...
    boolean canBeEqual(final Object other) {
        return other instanceof ExpressionAndNode;
    }
