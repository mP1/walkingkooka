 ...
 */
final class ExpressionNodeSelectorConcatFunction extends ExpressionNodeSelectorFunction<String> {

    /**
     * Singleton
     */
    static final ExpressionNodeSelectorConcatFunction INSTANCE = new ExpressionNodeSelectorConcatFunction();

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorConcatFunction() {
        super();
    }
