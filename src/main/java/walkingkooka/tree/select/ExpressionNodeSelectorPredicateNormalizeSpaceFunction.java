 ...
 */
final class ExpressionNodeSelectorPredicateNormalizeSpaceFunction extends ExpressionNodeSelectorPredicateFunction<String> {
    /**
     * Singleton
     */
    static final ExpressionNodeSelectorPredicateNormalizeSpaceFunction INSTANCE = new ExpressionNodeSelectorPredicateNormalizeSpaceFunction();

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorPredicateNormalizeSpaceFunction() {
        super();
    }
