 ...
 */
final class ExpressionNodeSelectorStringLengthFunction extends ExpressionNodeSelectorFunction<Long> {
    /**
     * Singleton
     */
    static final ExpressionNodeSelectorStringLengthFunction INSTANCE = new ExpressionNodeSelectorStringLengthFunction();

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorStringLengthFunction() {
        super();
    }
