 ...
 */
final class NodeSelectorPredicateNodeSelectorParserTokenVisitor<N extends Node<N, NAME, ANAME, AVALUE>, NAME extends Name, ANAME extends Name, AVALUE>
    ...
    static ExpressionNode toExpressionNode(final NodeSelectorPredicateParserToken token) {
        final NodeSelectorPredicateNodeSelectorParserTokenVisitor visitor = new NodeSelectorPredicateNodeSelectorParserTokenVisitor();
     ...
     */
    // @VisibleForTesting
    NodeSelectorPredicateNodeSelectorParserTokenVisitor() {
        super();
    }
    ...
    protected void endVisit(final NodeSelectorFunctionParserToken token) {
        final ExpressionNodeName functionName = NodeSelectorPredicateFunction.checkSupported(token.functionName().value());
