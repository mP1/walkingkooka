 ...
 */
final class ExpressionNodeSelectorSubstringFunction extends ExpressionNodeSelectorFunction<String> {

    /**
     * Singleton
     */
    static final ExpressionNodeSelectorSubstringFunction INSTANCE = new ExpressionNodeSelectorSubstringFunction();

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorSubstringFunction() {
        super();
    }
