 ...
 * type as the first.
 */
final class ExpressionNodeSelectorPredicateComparisonFunction extends ExpressionNodeSelectorPredicateFunction<Boolean> {

    /**
     * Factory
     */
    static final ExpressionNodeSelectorPredicateComparisonFunction with(final ComparisonRelation relation) {
        Objects.requireNonNull(relation, "relation");

        return new ExpressionNodeSelectorPredicateComparisonFunction(relation);
    }

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorPredicateComparisonFunction(final ComparisonRelation relation) {
        super();
