 ...
 */
final class ExpressionNodeSelectorSubstringAfterFunction extends ExpressionNodeSelectorFunction<String> {

    /**
     * Singleton
     */
    static final ExpressionNodeSelectorSubstringAfterFunction INSTANCE = new ExpressionNodeSelectorSubstringAfterFunction();

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorSubstringAfterFunction() {
        super();
    }
