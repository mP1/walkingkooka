 ...
 */
final class ExpressionNodeSelectorPredicateNodeSelectorParserTokenVisitor<N extends Node<N, NAME, ANAME, AVALUE>, NAME extends Name, ANAME extends Name, AVALUE>
    ...
    static ExpressionNode toExpressionNode(final NodeSelectorPredicateParserToken token) {
        final ExpressionNodeSelectorPredicateNodeSelectorParserTokenVisitor visitor = new ExpressionNodeSelectorPredicateNodeSelectorParserTokenVisitor();
     ...
     */
    // @VisibleForTesting
    ExpressionNodeSelectorPredicateNodeSelectorParserTokenVisitor() {
        super();
    }
    ...
    protected void endVisit(final NodeSelectorFunctionParserToken token) {
        final ExpressionNodeName functionName = ExpressionNodeSelectorPredicateFunction.checkSupported(token.functionName().value());
