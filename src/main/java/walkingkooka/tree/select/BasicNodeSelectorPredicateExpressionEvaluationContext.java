 ...
 */
final class BasicNodeSelectorPredicateExpressionEvaluationContext<N extends Node<N, NAME, ANAME, AVALUE>, NAME extends Name, ANAME extends Name, AVALUE> implements
        NodeSelectorPredicateExpressionEvaluationContext<N, NAME, ANAME, AVALUE> {

    /**
     * Factory that creates a new {@link BasicNodeSelectorPredicateExpressionEvaluationContext}, using the given {@link Node} as the context.
     */
    static <N extends Node<N, NAME, ANAME, AVALUE>, NAME extends Name, ANAME extends Name, AVALUE> BasicNodeSelectorPredicateExpressionEvaluationContext<N, NAME, ANAME, AVALUE> with(final N node) {
        return new BasicNodeSelectorPredicateExpressionEvaluationContext(node);
    }

    /**
     * Private ctor use factory.
     */
    private BasicNodeSelectorPredicateExpressionEvaluationContext(final N node) {
        super();
        this.node = node;
    }
