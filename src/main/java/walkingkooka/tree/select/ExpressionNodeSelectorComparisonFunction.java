 ...
 * type as the first.
 */
final class ExpressionNodeSelectorComparisonFunction extends ExpressionNodeSelectorFunction<Boolean> {

    /**
     * Factory
     */
    static final ExpressionNodeSelectorComparisonFunction with(final ComparisonRelation relation) {
        Objects.requireNonNull(relation, "relation");

        return new ExpressionNodeSelectorComparisonFunction(relation);
    }

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorComparisonFunction(final ComparisonRelation relation) {
        super();
