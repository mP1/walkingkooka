 ...
 */
final class NodeSelectorPredicateNormalizeSpaceFunction extends NodeSelectorPredicateFunction<String> {
    /**
     * Singleton
     */
    static final NodeSelectorPredicateNormalizeSpaceFunction INSTANCE = new NodeSelectorPredicateNormalizeSpaceFunction();

    /**
     * Private ctor
     */
    private NodeSelectorPredicateNormalizeSpaceFunction() {
        super();
    }
