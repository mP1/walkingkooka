 ...
 */
final class ExpressionNodeSelectorPredicateStringLengthFunction extends ExpressionNodeSelectorPredicateFunction<Long> {
    /**
     * Singleton
     */
    static final ExpressionNodeSelectorPredicateStringLengthFunction INSTANCE = new ExpressionNodeSelectorPredicateStringLengthFunction();

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorPredicateStringLengthFunction() {
        super();
    }
