 ...
 */
abstract class ExpressionNodeSelectorFunction<T> implements BiFunction<List<Object>, ExpressionEvaluationContext, T> {

    /**
     * A {@link Map} holding all functions by name. This requires that all functions are stateless.
     */
    final static Map<ExpressionNodeName, ExpressionNodeSelectorFunction<?>> NAME_TO_FUNCTION = Maps.ordered();

    final static ExpressionNodeSelectorBooleanFunction BOOLEAN = ExpressionNodeSelectorBooleanFunction.INSTANCE;

    final static ExpressionNodeSelectorConcatFunction CONCAT = ExpressionNodeSelectorConcatFunction.INSTANCE;

    final static ExpressionNodeSelectorContainsFunction CONTAINS = ExpressionNodeSelectorContainsFunction.INSTANCE;

    final static ExpressionNodeSelectorEndsWithFunction ENDS_WITH = ExpressionNodeSelectorEndsWithFunction.INSTANCE;

    final static ExpressionNodeSelectorFalseFunction FALSE = ExpressionNodeSelectorFalseFunction.INSTANCE;

    final static ExpressionNodeSelectorNameFunction NAME = ExpressionNodeSelectorNameFunction.INSTANCE;

    final static ExpressionNodeSelectorNormalizeSpaceFunction NORMALIZE_SPACE = ExpressionNodeSelectorNormalizeSpaceFunction.INSTANCE;

    final static ExpressionNodeSelectorNumberFunction NUMBER = ExpressionNodeSelectorNumberFunction.INSTANCE;

    final static ExpressionNodeSelectorPositionFunction POSITION = ExpressionNodeSelectorPositionFunction.INSTANCE;

    final static ExpressionNodeSelectorStartsWithFunction STARTS_WITH = ExpressionNodeSelectorStartsWithFunction.INSTANCE;

    final static ExpressionNodeSelectorStringLengthFunction STRING_LENGTH = ExpressionNodeSelectorStringLengthFunction.INSTANCE;

    final static ExpressionNodeSelectorSubstringFunction SUBSTRING = ExpressionNodeSelectorSubstringFunction.INSTANCE;

    final static ExpressionNodeSelectorSubstringAfterFunction SUBSTRING_AFTER = ExpressionNodeSelectorSubstringAfterFunction.INSTANCE;

    final static ExpressionNodeSelectorSubstringBeforeFunction SUBSTRING_BEFORE = ExpressionNodeSelectorSubstringBeforeFunction.INSTANCE;

    final static ExpressionNodeSelectorTextFunction TEXT = ExpressionNodeSelectorTextFunction.INSTANCE;

    final static ExpressionNodeSelectorTrueFunction TRUE = ExpressionNodeSelectorTrueFunction.INSTANCE;
     ...
     */
    ExpressionNodeSelectorFunction() {
        super();
        if (false == this instanceof ExpressionNodeSelectorComparisonFunction) {
