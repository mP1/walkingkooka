 ...
 */
final class ExpressionNodeSelectorNormalizeSpaceFunction extends ExpressionNodeSelectorFunction<String> {
    /**
     * Singleton
     */
    static final ExpressionNodeSelectorNormalizeSpaceFunction INSTANCE = new ExpressionNodeSelectorNormalizeSpaceFunction();

    /**
     * Private ctor
     */
    private ExpressionNodeSelectorNormalizeSpaceFunction() {
        super();
    }
