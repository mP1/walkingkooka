 ...
 */
final class NodeSelectorNodeAttributeValuePredicate<N extends Node<N, NAME, ANAME, AVALUE>, NAME extends Name, ANAME extends Name, AVALUE>  implements Predicate<N> {

    /**
     * Ctor only called by {@link NodeSelector#asPredicate()}
     */
    NodeSelectorNodeAttributeValuePredicate(final NodeSelector<N, NAME, ANAME, AVALUE> selector) {
