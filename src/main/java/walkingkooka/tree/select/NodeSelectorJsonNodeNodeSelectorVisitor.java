 ...
 */
final class NodeSelectorJsonNodeNodeSelectorVisitor<N extends Node<N, NAME, ANAME, AVALUE>,
        NAME extends Name,
        ANAME extends Name,
    ...
    static <N extends Node<N, NAME, ANAME, AVALUE>,
            NAME extends Name,
            ANAME extends Name,
            AVALUE> NodeSelector<N, NAME, ANAME, AVALUE> fromJsonNode(final BiFunction<JsonNode, FromJsonNodeContext, NAME> nameFactory,
    ...
    private static ExpressionNode parseExpression(final String expression) {
        final Parser<NodeSelectorParserContext> parser = NodeSelectorParsers.predicate()
                ...
                .cast();
        final NodeSelectorPredicateParserToken token = parser.parse(TextCursors.charSequence(expression), NodeSelectorParserContexts.basic(NodeSelectorJsonNodeNodeSelectorVisitor::hasMathContext))
                .get()
                .cast();
    ...
    static <N extends Node<N, NAME, ANAME, AVALUE>,
        ...
        final NodeSelectorJsonNodeNodeSelectorVisitor<N, NAME, ANAME, AVALUE> visitor = new NodeSelectorJsonNodeNodeSelectorVisitor<>(context);
        visitor.accept(selector);
        return visitor.toJsonNode();
    }

    // VisibleForTesting
    NodeSelectorJsonNodeNodeSelectorVisitor(final ToJsonNodeContext context) {
        super();
