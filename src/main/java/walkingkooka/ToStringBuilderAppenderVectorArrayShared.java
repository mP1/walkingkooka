...
abstract class ToStringBuilderAppenderVectorArrayShared<V> extends ToStringBuilderAppenderVectorShared<V> {

    ToStringBuilderAppenderVectorArrayShared(final V value) {
        super(value);
    }
