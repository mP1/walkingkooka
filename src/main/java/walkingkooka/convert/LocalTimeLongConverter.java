 ...
 */
final class LocalTimeLongConverter extends LocalTimeConverter<Long> {

    /**
     * Singleton
     */
    final static LocalTimeLongConverter INSTANCE = new LocalTimeLongConverter();

    /**
     * Private ctor use singleton
     */
    private LocalTimeLongConverter() {
    }
