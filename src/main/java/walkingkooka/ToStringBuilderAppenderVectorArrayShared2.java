...
abstract class ToStringBuilderAppenderVectorArrayShared2<T> extends ToStringBuilderAppenderVectorArrayShared<T> {

    ToStringBuilderAppenderVectorArrayShared2(final T value) {
        super(value);
    }
