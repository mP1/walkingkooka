...
final class ToStringBuilderAppenderVectorArraySharedBoolean extends ToStringBuilderAppenderVectorArrayShared<boolean[]> {

    static ToStringBuilderAppenderVectorArraySharedBoolean with(final boolean[] value) {
        return new ToStringBuilderAppenderVectorArraySharedBoolean(value);
    }

    private ToStringBuilderAppenderVectorArraySharedBoolean(final boolean[] value) {
        super(value);
    }
