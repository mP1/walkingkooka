 ...
 */
abstract class MaxOrMinPushableStreamStreamTerminalPushableStreamConsumer<T> extends PushableStreamStreamTerminalPushableStreamConsumer<T, Optional<T>> {
     ...
     */
    MaxOrMinPushableStreamStreamTerminalPushableStreamConsumer(final Comparator<? super T> comparator,
