 ...
 */
abstract class LimitOrSkipPushableStreamStreamIntermediatePushableStreamConsumer<T> extends PushableStreamStreamIntermediatePushableStreamConsumer<T> {

    LimitOrSkipPushableStreamStreamIntermediatePushableStreamConsumer(final long limitOrSkip,
