 ...
 */
final class AllMatchPushableStreamStreamTerminalPushableStreamConsumer<T> extends PredicatePushableStreamStreamTerminalPushableStreamConsumer<T> {
    ...
    private AllMatchPushableStreamStreamTerminalPushableStreamConsumer(final Predicate<? super T> predicate,
                                                                       final CloseableCollection closeables) {
