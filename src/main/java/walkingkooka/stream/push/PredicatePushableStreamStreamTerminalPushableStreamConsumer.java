 ...
 */
abstract class PredicatePushableStreamStreamTerminalPushableStreamConsumer<T> extends PushableStreamStreamTerminalPushableStreamConsumer<T, Boolean> {

    /**
     * Package private to limit sub classing.
     */
    PredicatePushableStreamStreamTerminalPushableStreamConsumer(final boolean result,
