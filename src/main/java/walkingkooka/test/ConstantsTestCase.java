 ...
 */
abstract public class ConstantsTestCase<T> extends TestCase {

    protected ConstantsTestCase() {
        super();
    }
     ...
     * another.
     */
    @Test final public void testConstantsAreUnique() throws Exception {
        final Set<Object> unique = Sets.hash();
        final Set<T> duplicateExceptionsSet = this.intentionalDuplicates();
    ...
    abstract protected Set<T> intentionalDuplicates();
}
