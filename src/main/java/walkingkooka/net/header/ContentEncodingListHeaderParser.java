 ...
 * </pre>
 */
final class ContentEncodingListHeaderParser extends HeaderParser {

    static List<ContentEncoding> parseContentEncodingList(final String text) {
        final ContentEncodingListHeaderParser parser = new ContentEncodingListHeaderParser(text);
        parser.parse();
        return Lists.readOnly(parser.contentEncodings);
    }

    private ContentEncodingListHeaderParser(final String text) {
        super(text);
    }
