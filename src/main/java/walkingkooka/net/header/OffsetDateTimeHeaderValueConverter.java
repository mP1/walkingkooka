...
/**
 * A {@link HeaderValueConverter} that parses a header value into a {@link OffsetDateTime}.
 * Sample Date/Time
 * <pre>
 ...
 */
final class OffsetDateTimeHeaderValueConverter extends NonStringHeaderValueConverter<OffsetDateTime> {

    /**
     * Singleton
     */
    final static OffsetDateTimeHeaderValueConverter INSTANCE = new OffsetDateTimeHeaderValueConverter();

    /**
     * Private ctor use singleton.
     */
    private OffsetDateTimeHeaderValueConverter() {
        super();
    }
    ...
    private final static HeaderValueConverter<String> QUOTED_STRING = HeaderValueConverter.quoted(
