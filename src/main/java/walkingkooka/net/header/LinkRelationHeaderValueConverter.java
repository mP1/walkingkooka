 ...
 */
final class LinkRelationHeaderValueConverter extends NonStringHeaderValueConverter<List<LinkRelation<?>>> {

    /**
     * Singleton
     */
    final static LinkRelationHeaderValueConverter INSTANCE = new LinkRelationHeaderValueConverter();

    /**
     * Private ctor use singleton.
     */
    private LinkRelationHeaderValueConverter() {
        super();
    }
