...
/**
 * A {@link HeaderValueConverter} that parses a content header value into a {@link ContentDispositionFileNameNotEncoded}.
 */
final class ContentDispositionFileNameNotEncodedHeaderValueConverter extends ContentDispositionFileNameHeaderValueConverter<ContentDispositionFileNameNotEncoded> {

    /**
     * Singleton
     */
    final static ContentDispositionFileNameNotEncodedHeaderValueConverter INSTANCE = new ContentDispositionFileNameNotEncodedHeaderValueConverter();

    /**
     * Private ctor use singleton.
     */
    private ContentDispositionFileNameNotEncodedHeaderValueConverter() {
        super();
    }
