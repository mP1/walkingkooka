 ...
 * </pre>
 */
final class ContentDispositionHeaderValueParser extends HeaderValueParserWithParameters<ContentDisposition,
        ContentDispositionParameterName<?>> {

    static ContentDisposition parseContentDisposition(final String text) {
        final ContentDispositionHeaderValueParser parser = new ContentDispositionHeaderValueParser(text);
        parser.parse();
        return parser.disposition;
    }

    private ContentDispositionHeaderValueParser(final String text) {
        super(text);
    }
