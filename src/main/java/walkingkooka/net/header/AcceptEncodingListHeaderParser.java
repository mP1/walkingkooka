 ...
 * </pre>
 */
final class AcceptEncodingListHeaderParser extends HeaderParserWithParameters<AcceptEncoding, AcceptEncodingParameterName<?>> {

    static List<AcceptEncoding> parseAcceptEncodingList(final String text) {
        final AcceptEncodingListHeaderParser parser = new AcceptEncodingListHeaderParser(text);
        parser.parse();
        return Lists.readOnly(parser.acceptEncodings);
    }

    private AcceptEncodingListHeaderParser(final String text) {
        super(text);
    }
