 ...
 */
final class HeaderValueEmailAddressConverter extends ReadOnlyHeaderValueConverter<EmailAddress> {

    /**
     * Singleton
     */
    final static HeaderValueEmailAddressConverter INSTANCE = new HeaderValueEmailAddressConverter();

    /**
     * Private ctor use singleton.
     */
    private HeaderValueEmailAddressConverter() {
        super();
    }
