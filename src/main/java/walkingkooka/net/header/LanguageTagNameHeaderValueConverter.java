 ...
 */
final class LanguageTagNameHeaderValueConverter extends NonStringHeaderValueConverter<LanguageTagName> {

    /**
     * Singleton
     */
    final static LanguageTagNameHeaderValueConverter INSTANCE = new LanguageTagNameHeaderValueConverter();

    /**
     * Private ctor use singleton.
     */
    private LanguageTagNameHeaderValueConverter() {
        super();
    }
