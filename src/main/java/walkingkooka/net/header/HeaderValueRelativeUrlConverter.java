 ...
 */
final class HeaderValueRelativeUrlConverter extends ReadOnlyHeaderValueConverter<RelativeUrl> {

    /**
     * Singleton
     */
    final static HeaderValueRelativeUrlConverter INSTANCE = new HeaderValueRelativeUrlConverter();

    /**
     * Private ctor use singleton.
     */
    private HeaderValueRelativeUrlConverter() {
        super();
    }
