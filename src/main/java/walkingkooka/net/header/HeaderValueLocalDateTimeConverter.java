 ...
 */
final class HeaderValueLocalDateTimeConverter extends HeaderValueConverter2<LocalDateTime> {

    /**
     * Singleton
     */
    final static HeaderValueLocalDateTimeConverter INSTANCE = new HeaderValueLocalDateTimeConverter();

    /**
     * Private ctor use singleton.
     */
    private HeaderValueLocalDateTimeConverter() {
        super();
    }
