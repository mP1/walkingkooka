 ...
 */
final class ETagListHeaderValueConverter extends HeaderValueConverter<List<ETag>> {

    /**
     * Singleton
     */
    final static ETagListHeaderValueConverter INSTANCE = new ETagListHeaderValueConverter();

    /**
     * Private ctor use singleton.
     */
    private ETagListHeaderValueConverter() {
        super();
    }
