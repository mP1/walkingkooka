 ...
 * </pre>
 */
final class HttpHeaderValueRangeConverter extends HttpHeaderValueConverter<HttpHeaderRange> {

    /**
     * Singleton
     */
    final static HttpHeaderValueRangeConverter INSTANCE = new HttpHeaderValueRangeConverter();

    /**
     * Private ctor use singleton.
     */
    private HttpHeaderValueRangeConverter() {
        super();
    }
