 ...
 */
final class HttpServletRequestHttpRequestHeadersMapEntrySetIterator implements Iterator<Entry<HttpHeaderName<?>, Object>> {
    ...
    @Override
    public Entry<HttpHeaderName<?>, Object> next() {
