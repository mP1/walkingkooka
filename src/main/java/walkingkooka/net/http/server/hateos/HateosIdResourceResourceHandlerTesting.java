...
/**
 * Mixin interface for testing {@link HateosIdResourceResourceHandler}
 */
public interface HateosIdResourceResourceHandlerTesting<H extends HateosIdResourceResourceHandler<I, R, S>,
    ...
    default void handleAndCheck(final HateosIdResourceResourceHandler<I, R, S> handler,
                                final I id,
                                final Optional<R> resource,
                                final Map<HttpRequestAttribute<?>, Object> parameters,
                                final Optional<S> result) {
    ...
    default <T extends Throwable> T handleFails(final HateosIdResourceResourceHandler<I, R, S> handler,
                                                final I id,
                                                final Optional<R> resource,
                                                final Map<HttpRequestAttribute<?>, Object> parameters,
                                                final Class<T> thrown) {
    ...
    default String typeNameSuffix() {
        return HateosIdResourceResourceHandler.class.getSimpleName();
    }
}
