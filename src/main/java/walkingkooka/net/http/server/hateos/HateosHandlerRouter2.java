 ...
 */
abstract class HateosHandlerRouter2<N extends Node<N, ?, ?, ?>> {

    /**
     * Package private to limit sub classing.
     */
    HateosHandlerRouter2(final AbsoluteUrl base,
                         final HateosContentType<N> contentType,
                         final Map<HateosHandlerRouterKey, HateosHandlerRouterMapper<?, ?, ?>> mappers) {
        super();
        this.base = base;
