 ...
 */
final class HttpHeaderNameListHttpHeaderValueConverter extends HttpHeaderValueConverter<List<HttpHeaderName<?>>> {

    /**
     * Singleton
     */
    final static HttpHeaderNameListHttpHeaderValueConverter INSTANCE = new HttpHeaderNameListHttpHeaderValueConverter();

    /**
     * Private ctor use singleton.
     */
    private HttpHeaderNameListHttpHeaderValueConverter() {
        super();
    }
