...
/**
 * A {@link HttpHeaderValueConverter} that parses a header value into a {@link LocalDateTime}.
 * Sample Date/Time
 * <pre>
 ...
 */
final class HttpHeaderValueLocalDateTimeConverter extends HttpHeaderValueConverter<LocalDateTime> {

    /**
     * Singleton
     */
    final static HttpHeaderValueLocalDateTimeConverter INSTANCE = new HttpHeaderValueLocalDateTimeConverter();

    /**
     * Private ctor use singleton.
     */
    private HttpHeaderValueLocalDateTimeConverter() {
        super();
    }
