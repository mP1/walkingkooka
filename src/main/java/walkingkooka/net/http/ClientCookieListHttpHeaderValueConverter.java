 ...
 */
final class ClientCookieListHttpHeaderValueConverter extends HttpHeaderValueConverter<List<ClientCookie>> {

    /**
     * Singleton
     */
    final static ClientCookieListHttpHeaderValueConverter INSTANCE = new ClientCookieListHttpHeaderValueConverter();

    /**
     * Private ctor use singleton.
     */
    private ClientCookieListHttpHeaderValueConverter() {
        super();
    }
